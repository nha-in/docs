...
for f in scaffold integrate debug test; do curl -fsSL https://nha-in.github.io/docs/pr-14/skills/abdm-m1/references/$f.md -o .claude/skills/abdm-m1/references/$f.md; done
```
...
- https://nha-in.github.io/docs/pr-14/skills/abdm-phr-services/
