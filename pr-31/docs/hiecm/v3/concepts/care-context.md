...
A Care Context represents a logical grouping of a patient's health records. Each [HMIS](/docs/pr-31/docs/hiecm/v3/getting-started/glossary#hmis)/[LMIS](/docs/pr-31/docs/hiecm/v3/getting-started/glossary#lmis) system should define how patient data is organised into one or more care contexts in a meaningful and consistent way.

A care context serves as the unit that is associated with a patient's [ABHA address](/docs/pr-31/docs/hiecm/v3/getting-started/glossary#abha-address) within the system.

## Key design principles

The [HIE-CM](/docs/pr-31/docs/hiecm/v3/getting-started/glossary#hie-cm) (Health Information Exchange & Consent Manager) is designed to be data-blind.
...
- **Reference ID.** A unique internal identifier assigned by the [HRP](/docs/pr-31/docs/hiecm/v3/getting-started/glossary#hrp) (HMIS/LMIS). Used to link and retrieve the associated health records.
...
- [Linking](/docs/pr-31/docs/hiecm/v3/concepts/linking), how a care context reaches the patient's ABHA address.
- [M2 Attach](/docs/pr-31/docs/hiecm/v3/milestones/m2), the milestone that links care contexts and shares the records in them.
- [M2 API reference](/docs/pr-31/docs/hiecm/v3/api/m2), the calls that carry a care context.
