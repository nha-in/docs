...
[Dummy payer, act on a request in the API reference](/docs/pr-31/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-process-request)
...
- Both should read [The JWE message format](/docs/pr-31/docs/nhcx/v1/getting-started/jwe-message-format) before writing a second use case; it is where the status words and the retry rules live.
