...
- A provider completes the [Web Application Security Assessment (WASA)](/docs/pr-13/docs/nhcx/v1/getting-started/glossary#identity-and-registration) for [ABDM](/docs/pr-13/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) Milestone 1. NHCX production runs on that same production client.
...
- Your integration runs every use case on the exit list for your side: the [Provider Checklist](/docs/pr-13/docs/nhcx/v1/roles/provider/provider-checklist) or the [Payer Checklist](/docs/pr-13/docs/nhcx/v1/roles/payer/payer-checklist).
...
| WASA security audit                         | ABDM Milestone 1 production access, which NHCX production builds on. Under [PMJAY](/docs/pr-13/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) it is also on the sandbox exit list | Clearance for ABDM production access   |
...
Milestone 1 production credentials follow Milestone 1 functional testing, the WASA security audit and the [Health Tech Committee (HTC)](/docs/pr-13/docs/nhcx/v1/getting-started/glossary#identity-and-registration) demo. For a hospital, the provider role is then assigned to that Milestone 1 production client ID. The same client ID gives you NHCX production access, so the audit comes before NHCX production.

Under PMJAY, the sandbox exit adds the PMJAY team demo, the WASA audit and the NHCX sandbox exit form. [PMJAY on NHCX](/docs/pr-13/docs/nhcx/v1/concepts/pmjay-on-nhcx) has the scheme's full order.
...
- [Going Live](/docs/pr-13/docs/nhcx/v1/go-live): the production credentials, registration and switch that follow.
- [Governance and Audit](/docs/pr-13/docs/nhcx/v1/reference/governance-and-audit): the security obligations that continue in production, and the full onboarding question list.
