...
- **FHIR Reference:** [Predetermination, Status and Search, A5](/docs/pr-13/docs/nhcx/v1/reference/fhir/predetermination-status-and-search#a5-get-status-shared)
...
- **FHIR Reference:** [Coverage Eligibility Request, B1](/docs/pr-13/docs/nhcx/v1/reference/fhir/coverage-eligibility-request#b1-check-coverage-eligibility-provider)
...
- **FHIR Reference:** [Insurance Plan Request, B2](/docs/pr-13/docs/nhcx/v1/reference/fhir/insurance-plan-request#b2-request-insurance-plan-provider)
...
- **FHIR Reference:** [Preauthorisation Request, B3](/docs/pr-13/docs/nhcx/v1/reference/fhir/preauthorisation-request#b3-submit-pre-authorisation-provider)
...
- **FHIR Reference:** [Communication, B4](/docs/pr-13/docs/nhcx/v1/reference/fhir/communication#b4-respond-to-a-communication-provider)
...
- **FHIR Reference:** [Claim Request, B5](/docs/pr-13/docs/nhcx/v1/reference/fhir/claim-request#b5-submit-claim-provider)
...
- **FHIR Reference:** [Predetermination, Status and Search, B6](/docs/pr-13/docs/nhcx/v1/reference/fhir/predetermination-status-and-search#b6-search-claims-provider)
...
- **FHIR Reference:** [Payment Notice and Acknowledgement, B7](/docs/pr-13/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement#b7-acknowledge-payment-notice-provider)
...
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, B8](/docs/pr-13/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#b8-reprocess-or-cancel-provider)
...
- **FHIR Reference:** [Predetermination, Status and Search, B9](/docs/pr-13/docs/nhcx/v1/reference/fhir/predetermination-status-and-search#b9-submit-predetermination-provider)
...
- **FHIR Reference:** [Insurance Plan Request, D1](/docs/pr-13/docs/nhcx/v1/reference/fhir/insurance-plan-request#d1-fetch-the-insurance-plan-pmjay)
...
- **FHIR Reference:** [Coverage Eligibility Request, D3](/docs/pr-13/docs/nhcx/v1/reference/fhir/coverage-eligibility-request#d3-check-coverage-eligibility-pmjay)
...
- **FHIR Reference:** [Preauthorisation Request, D4](/docs/pr-13/docs/nhcx/v1/reference/fhir/preauthorisation-request#d4-submit-pre-authorisation-pmjay)
...
- **FHIR Reference:** [Preauthorisation Request, D5](/docs/pr-13/docs/nhcx/v1/reference/fhir/preauthorisation-request#d5-resubmit-pre-authorisation-pmjay)
...
- **FHIR Reference:** [Preauthorisation Enhancement, D6](/docs/pr-13/docs/nhcx/v1/reference/fhir/preauthorisation-enhancement#d6-raise-an-enhancement-pmjay)
...
- **FHIR Reference:** [Preauthorisation Query and Answer, D7](/docs/pr-13/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer#d7-answer-a-pre-authorisation-query-pmjay)
...
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, D8](/docs/pr-13/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#d8-cancel-pre-authorisation-pmjay)
...
- **FHIR Reference:** [Claim Request, D9](/docs/pr-13/docs/nhcx/v1/reference/fhir/claim-request#d9-submit-claim-pmjay)
...
- **FHIR Reference:** [Claim Query and Answer, D10](/docs/pr-13/docs/nhcx/v1/reference/fhir/claim-query-and-answer#d10-answer-a-claim-query-pmjay)
...
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, D11](/docs/pr-13/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#d11-reprocess-a-rejected-claim-pmjay)
...
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, D12](/docs/pr-13/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#d12-claim-a-shortfall-pmjay)
...
- **FHIR Reference:** [Payment Notice and Acknowledgement, D13](/docs/pr-13/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement#d13-acknowledge-the-payment-notice-pmjay)
...
- **FHIR Reference:** [Coverage Eligibility Response, C3](/docs/pr-13/docs/nhcx/v1/reference/fhir/coverage-eligibility-response#c3-respond-to-coverage-eligibility-payer)
...
- **FHIR Reference:** [Insurance Plan Response Overview, C4](/docs/pr-13/docs/nhcx/v1/reference/fhir/insurance-plan-response-overview#c4-respond-to-insurance-plan-request-payer)
...
- **FHIR Reference:** [Preauthorisation Response, C5](/docs/pr-13/docs/nhcx/v1/reference/fhir/preauthorisation-response#c5-respond-to-pre-authorisation-payer)
...
- **FHIR Reference:** [Communication, C6](/docs/pr-13/docs/nhcx/v1/reference/fhir/communication#c6-raise-a-communication-payer)
...
- **FHIR Reference:** [Claim Response, C7](/docs/pr-13/docs/nhcx/v1/reference/fhir/claim-response#c7-respond-to-claim-payer)
...
- **FHIR Reference:** [Predetermination, Status and Search, C8](/docs/pr-13/docs/nhcx/v1/reference/fhir/predetermination-status-and-search#c8-respond-to-search-payer)
...
- **FHIR Reference:** [Payment Notice and Acknowledgement, C9](/docs/pr-13/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement#c9-send-payment-notice-payer)
...
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, C10](/docs/pr-13/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#c10-respond-to-a-task-payer)
...
- **FHIR Reference:** [Predetermination, Status and Search, C11](/docs/pr-13/docs/nhcx/v1/reference/fhir/predetermination-status-and-search#c11-respond-to-predetermination-payer)
...
| **20 to 22**  | Preauth Newborn Registration       | `/preauth/submit` & `on_submit`           | Newborn registered under mother's ABHA/PMJAY policy, birth certificate                    | [`docs/05-FHIR Reference/12-Claim Request.md`](/docs/pr-13/docs/nhcx/v1/reference/fhir/claim-request) |
