...
|                    |                                                                                                                                    |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/task/submit` [`apis/13-other/v1-task-submit.bru`](/docs/pr-13/docs/nhcx/v1/api/other/endpoints/other-v1-task-submit)          |
| **Callback**       | `/v1/task/on_submit` [`apis/13-other/v1-task-on-submit.bru`](/docs/pr-13/docs/nhcx/v1/api/other/endpoints/other-v1-task-on-submit) |
...
|                    |                                                                                                                                    |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/task/on_submit` [`apis/13-other/v1-task-on-submit.bru`](/docs/pr-13/docs/nhcx/v1/api/other/endpoints/other-v1-task-on-submit) |
| **Callback**       | `/v1/task/submit` [`apis/13-other/v1-task-submit.bru`](/docs/pr-13/docs/nhcx/v1/api/other/endpoints/other-v1-task-submit)          |
