...
- [P1](/docs/pr-13/reference/hiecm-p1), identity and profile, 63 operations
- [P2](/docs/pr-13/reference/hiecm-p2), linking and records, 49 operations
- [P3](/docs/pr-13/reference/hiecm-p3), consent and notifications, 35 operations
- [PHR application services](/docs/pr-13/reference/hiecm-phr-services), 61 operations, which is **not** a certification milestone
...
- [M1 API reference](/docs/pr-13/reference/hiecm-m1), 44 operations, up from 32
- [M2 API reference](/docs/pr-13/reference/hiecm-m2), 10 operations, up from none
- [M3 API reference](/docs/pr-13/reference/hiecm-m3), 6 operations and 6 callbacks, up from none
- [Gateway reference](/docs/pr-13/reference/hiecm-gateway), 7 operations. The gateway group repeats this group in all three files, so it is described once
