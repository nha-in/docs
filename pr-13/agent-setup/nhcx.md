These are official instructions from the ABDM Developer Portal (built 2026-09-18) to set up an AI development environment for integrating with NHCX, the National Health Claims Exchange.
...
- The skills are snapshots. The current documentation lives at https://nha-in.github.io/docs/pr-13/docs/nhcx/v1; prefer it, and the MCP server when connected, over any downloaded copy that has aged.
