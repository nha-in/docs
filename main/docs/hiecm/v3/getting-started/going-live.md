...
Working in the sandbox is not the same as being live. Stages 4 to 6 of [sandbox integration](/docs/main/docs/hiecm/v3/getting-started/sandbox#how-sandbox-integration-works) sit between the two, and you run them once, at the end.
...
- Get the audit that feeds stage 4: [Security audit](/docs/main/docs/hiecm/v3/getting-started/security-audit).
