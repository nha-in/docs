...
Counter names arrive in the QR code: 1 to 250 characters, letters, digits and spaces, with `.`, `-` or `_` allowed inside the name, examples OPD, OPD1, OPD cardio, IPD1, Pharmacy. A counter name cannot be the [HFR](/docs/main/docs/hiecm/v3/getting-started/glossary#hfr) facility ID, the [HPID](/docs/main/docs/hiecm/v3/getting-started/glossary#hpid), the HIP ID or the HIP name.
