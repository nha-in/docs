...
Your identity is an [ABHA](/docs/main/docs/hiecm/v3/getting-started/glossary#abha), the Ayushman Bharat Health Account. It has two parts.

|                | ABHA number                                                                                      | ABHA address                               |
| -------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------ |
| What it is     | 14 digits, such as `91-XXXX-XXXX-XXXX`                                                           | A readable name, such as `name@abdm`       |
| How you get it | After an Aadhaar based [KYC](/docs/main/docs/hiecm/v3/getting-started/glossary#kyc) check passes | You choose it, or you are issued a default |
...
A [PHR](/docs/main/docs/hiecm/v3/getting-started/glossary#phr) app holds your account and acts for you. Hospitals, laboratories and pharmacies address records to your ABHA address.

## What you can do

- Create an ABHA, by Aadhaar [OTP](/docs/main/docs/hiecm/v3/getting-started/glossary#otp), face authentication, biometrics or a demographic match.
...
Your records stay in the systems that created them. The [HIE-CM](/docs/main/docs/hiecm/v3/getting-started/glossary#hie-cm) holds identifiers, pointers and consent, never the record itself. Nothing central collects your health history.
...
[Consent](/docs/main/docs/hiecm/v3/concepts/consent) explains what a request carries and the states it moves through.
