...
- **A server you run** holds the client ID and secret, mints the [gateway session token](/docs/main/docs/hiecm/v3/concepts/gateway), and hosts the callback URL registered for your bridge.
...
A subscription is not consent and gives nobody a record. Reading the record still needs a consent, which is why a subscription usually runs alongside an auto approval policy. [P3](/docs/main/docs/hiecm/v3/milestones/p3) describes both.
...
- **[HPR](/docs/main/docs/hiecm/v3/getting-started/glossary#hpr) and [HFR](/docs/main/docs/hiecm/v3/getting-started/glossary#hfr) registration.** [M4](/docs/main/docs/hiecm/v3/milestones/m4) covers the professional and facility registries.
- **[UHI](/docs/main/docs/hiecm/v3/getting-started/glossary#uhi) and [NHCX](/docs/main/docs/hiecm/v3/getting-started/glossary#nhcx).** Booking, and claims and insurance exchange, run on separate gateways.
