...
[ABDM](/docs/main/docs/hiecm/v3/getting-started/glossary#abdm) has three moving parts: registries that issue identifiers, the [HIE-CM](/docs/main/docs/hiecm/v3/getting-started/glossary#hie-cm) gateway that routes requests and holds consent, and the two roles a record moves between.
...
| ------------- | --------------------------------------------------- | ----------------------------------------------- | ------------------------------------------ | ------------------------------------- |
| Care seeker   | [ABHA](/docs/main/docs/hiecm/v3/registries/abha)    | A patient                                       | 14 digit ABHA number, plus an ABHA address | [M1](/docs/main/docs/hiecm/v3/api/m1) |
| Care provider | [HPR](/docs/main/docs/hiecm/v3/registries/nhpr/hpr) | A doctor, nurse, pharmacist or facility manager | HPR ID                                     | [M4](/docs/main/docs/hiecm/v3/api/m4) |
| Care provider | [HFR](/docs/main/docs/hiecm/v3/registries/nhpr/hfr) | A hospital, clinic, lab or pharmacy             | Facility ID                                | [M4](/docs/main/docs/hiecm/v3/api/m4) |

[ABHA](/docs/main/docs/hiecm/v3/getting-started/glossary#abha) is the care seeker's. [HPR](/docs/main/docs/hiecm/v3/getting-started/glossary#hpr) and [HFR](/docs/main/docs/hiecm/v3/getting-started/glossary#hfr) sit together under NHPR and are the care provider's: one for the professional, one for the place. [Registries](/docs/main/docs/hiecm/v3/registries) has what each one holds.
...
[The ABDM gateway](/docs/main/docs/hiecm/v3/concepts/gateway) covers the gateway and the session token every call carries.
...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [IMS](/docs/main/docs/hiecm/v3/getting-started/glossary#ims) | A care provider. An HMIS in a hospital, an EMR in a clinic, a LIMS in a laboratory, a PMS in a pharmacy | [M1](/docs/main/docs/hiecm/v3/milestones/m1) to [M4](/docs/main/docs/hiecm/v3/milestones/m4) |
| [PHR](/docs/main/docs/hiecm/v3/getting-started/glossary#phr) | A care seeker, who holds their own records and gives consent                                            | [P1](/docs/main/docs/hiecm/v3/milestones/p1) to [P3](/docs/main/docs/hiecm/v3/milestones/p3) |

[HIP](/docs/main/docs/hiecm/v3/getting-started/glossary#hip) and [HIU](/docs/main/docs/hiecm/v3/getting-started/glossary#hiu) are not a third and a fourth role, and they are not something you register as. They are the two ends of one record moving: whoever publishes it is the HIP for that exchange, and whoever asks to read one they did not create is the HIU.
...
| `hipId`, `hipName`, `hipType` | Each facility, once per bridge it links to | [The bridge linkage call](/docs/main/docs/hiecm/v3/milestones/m4#journey-4-linking-bridges-to-a-facility) |

Every callback for every facility arrives at the one bridge URL. The header says which facility it belongs to: `X-HIP-ID` in [M2](/docs/main/docs/hiecm/v3/api/m2), and `X-HIU-ID` in M2 and [M3](/docs/main/docs/hiecm/v3/api/m3). That header is what your handler routes a callback on, and the facility ID is what your records key to.
...
- A **care context** is a pointer, not content: a reference number and a display name. Putting a diagnosis or a result in that name is not allowed. See [linking](/docs/main/docs/hiecm/v3/concepts/linking).
- A **consent artefact** is the patient's permission, scoped by purpose, record type and date range. See [consent](/docs/main/docs/hiecm/v3/concepts/consent).
- The **record** goes point to point, encrypted, from the HIP that holds it to the HIU that asked, once a consent artefact exists. It is packaged as a [FHIR](/docs/main/docs/hiecm/v3/getting-started/glossary#fhir) R4 bundle. See [data flow](/docs/main/docs/hiecm/v3/concepts/data-flow) and [FHIR](/docs/main/docs/hiecm/v3/concepts/fhir).
...
[Your integration path](/docs/main/docs/hiecm/v3/milestones) for what each role has to build.
