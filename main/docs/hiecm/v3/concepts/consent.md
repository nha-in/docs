...
- [M3, consent and fetching](/docs/main/docs/hiecm/v3/api/m3), the requesting side.
- [M2, linking and sharing](/docs/main/docs/hiecm/v3/api/m2), what a record holder validates.
