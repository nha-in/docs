...
- [M3 Retrieve, Health Information User Services](/docs/main/docs/hiecm/v3/api/m3), the requesting side.
- [M2 Attach, Health Information Provider Services](/docs/main/docs/hiecm/v3/api/m2), what a record holder validates.
