...
- **You get an acknowledgement, not an answer.** In the [M3](/docs/main/docs/hiecm/v3/getting-started/glossary#m3) consent flow the [HIU](/docs/main/docs/hiecm/v3/getting-started/glossary#hiu) asks, the HIE-CM returns the consent request id on a callback, and the patient's decision comes back later. Each call's page in the [API reference](/docs/main/docs/hiecm/v3/api) names the callback it produces.
- **You have to be reachable.** Half of [M2](/docs/main/docs/hiecm/v3/getting-started/glossary#m2) is endpoints the gateway calls on your system.
