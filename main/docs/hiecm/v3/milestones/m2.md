...
Milestone 2 attaches the health records you hold to a person's [ABHA address](/docs/main/docs/hiecm/v3/getting-started/glossary#abha-address). After it you can group records into [care contexts](/docs/main/docs/hiecm/v3/getting-started/glossary#care-context), link them, answer [discovery](/docs/main/docs/hiecm/v3/getting-started/glossary#discovery) requests from [PHR](/docs/main/docs/hiecm/v3/getting-started/glossary#phr) apps, and push encrypted records when a consented request arrives.
...
- Your facility is the [HIP](/docs/main/docs/hiecm/v3/getting-started/glossary#hip) when it publishes a record, and your software is how it publishes. A valid facility ID and registration in the HIP role come first, either from the NHPR portal by hand or by building [M4 Enrol](/docs/main/docs/hiecm/v3/milestones/m4).
- M2 is keyed to an ABHA address, so [M1 Create](/docs/main/docs/hiecm/v3/milestones/m1) has to work before M2 can.
- Hold a [link token](/docs/main/docs/hiecm/v3/getting-started/glossary#link-token) per patient. Its validity is six months.
- Records go out as [FHIR](/docs/main/docs/hiecm/v3/getting-started/glossary#fhir) R4 against the ABDM profiles.
...
Hospitals, laboratories, pharmacies and imaging centres, through the software they record care in. A citizen pushing their own records from a PHR app builds [P2 Linking and records](/docs/main/docs/hiecm/v3/milestones/p2), the patient side of M2.

## Prerequisites

1. A valid facility ID and registration in the HIP role. That authorises your facility to create health records and share them with whoever asks to read them as the [HIU](/docs/main/docs/hiecm/v3/getting-started/glossary#hiu). It comes from [M4 Enrol](/docs/main/docs/hiecm/v3/milestones/m4).
2. A working [M1 Create](/docs/main/docs/hiecm/v3/milestones/m1) integration. Linking is keyed to an ABHA address.
...
An [HMIS](/docs/main/docs/hiecm/v3/getting-started/glossary#hmis) must implement every [HI type](/docs/main/docs/hiecm/v3/getting-started/glossary#hi-type).
...
M2 has no certification step of its own. One exit process covers the whole integration, run once, after every milestone your role needs works end to end. See [Going live](/docs/main/docs/hiecm/v3/getting-started/going-live) for the four steps and what each one asks of you.

Test data is in the [data dictionary](/docs/main/docs/hiecm/v3/reference/data-dictionary). [Support](/docs/main/docs/support) lists the channels. The cases you are certified against are in [M2 testing use cases](/docs/main/docs/hiecm/v3/resources/testing/m2).

## The journey, one diagram per flow

Milestone 2 (M2) of [ABDM](/docs/main/docs/hiecm/v3/getting-started/glossary#abdm) has four flows. This page draws each one, so you can see the round trips before you read the detail.

"Your system" is the [HMIS](/docs/main/docs/hiecm/v3/getting-started/glossary#hmis) or [LMIS](/docs/main/docs/hiecm/v3/getting-started/glossary#lmis) your facility publishes through. "HIE-CM" is the [Health Information Exchange and Consent Manager](/docs/main/docs/hiecm/v3/getting-started/glossary#hie-cm) gateway.
...
The patient gave you their [ABHA address](/docs/main/docs/hiecm/v3/getting-started/glossary#abha-address) at registration. Link the [care context](/docs/main/docs/hiecm/v3/getting-started/glossary#care-context) as soon as the record is ready: linking is what makes it reachable from [PHR](/docs/main/docs/hiecm/v3/getting-started/glossary#phr) apps.

Step 8 is the acknowledgement. Step 9 is the answer. The link is confirmed only when the callback arrives at `/v3/link/on_carecontext` on your bridge carrying `status`, so do not mark a record as linked on the strength of the 202. See [the outcome of a care context linking call](/docs/main/docs/hiecm/v3/api/m2/endpoints/m2-on-carecontext-result).
...
- **No valid [link token](/docs/main/docs/hiecm/v3/getting-started/glossary#link-token).** Validate the stored token before use, with a tool such as JWT.io. If it is expired or missing, regenerate it through demographic authentication.
...
The patient starts [discovery](/docs/main/docs/hiecm/v3/getting-started/glossary#discovery) from a PHR app and picks the facility they visited. Your system matches them on the identifiers the gateway passes you and answers with care contexts.
...
Encryption uses [ECDH](/docs/main/docs/hiecm/v3/getting-started/glossary#ecdh), Elliptic Curve Diffie Hellman, over Curve25519. Mechanics: [use cases](/docs/main/reference/hiecm-m2). Call order: [API reference](/docs/main/reference/hiecm-m2).
...
- The next milestone: [M3 Retrieve](/docs/main/docs/hiecm/v3/milestones/m3).
