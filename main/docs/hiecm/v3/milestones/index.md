...
[M1Create and verify the patient's ABHA, the identity every record hangs on.](/docs/main/docs/hiecm/v3/milestones/m1)[M2Attach the records you hold to that identity: care contexts, linking, and sharing as a HIP.](/docs/main/docs/hiecm/v3/milestones/m2)[M3Retrieve records held elsewhere, with the patient's consent, as an HIU.](/docs/main/docs/hiecm/v3/milestones/m3)[M4Enrol your facility and your professionals in the registries, so you can go live.](/docs/main/docs/hiecm/v3/milestones/m4)
...
If you are building the patient's app rather than the clinic's system, you are building a [PHR](/docs/main/docs/hiecm/v3/getting-started/glossary#phr) application. The work splits into three, and each part mirrors a milestone on the provider side.
...
| An insurer, a referral service or an analytics service | Required                                                       | Not needed                                                     | The bulk of your build                                         | [Confirm at onboarding](/docs/main/docs/hiecm/v3/concepts/participants/insurer#confirm-at-onboarding) |
| A citizen                                              | [P1](/docs/main/docs/hiecm/v3/milestones/p1), the patient side | [P2](/docs/main/docs/hiecm/v3/milestones/p2), the patient side | [P3](/docs/main/docs/hiecm/v3/milestones/p3), the patient side | Not needed                                                                                            |

## What each milestone gets you

| Milestone                                             | What you get                                | Who needs it                                                   |
| ----------------------------------------------------- | ------------------------------------------- | -------------------------------------------------------------- |
| [M1 Create](/docs/main/docs/hiecm/v3/milestones/m1)   | Identity and the session token              | Everyone                                                       |
| [M2 Attach](/docs/main/docs/hiecm/v3/milestones/m2)   | Linking and sharing records                 | A facility publishing records, and a citizen pushing their own |
| [M3 Retrieve](/docs/main/docs/hiecm/v3/milestones/m3) | Consent and record fetching                 | Anyone reading records they did not create, and every PHR app  |
| [M4 Enrol](/docs/main/docs/hiecm/v3/milestones/m4)    | A facility ID and professional registration | Anyone going live as a facility                                |
