...
[Try the P2 APIs](/docs/main/docs/hiecm/v3/api/p2)

[Every call in P2, one page each: the headers it needs, the payload it takes, the callback it triggers, and a request builder you can fire at the sandbox.](/docs/main/docs/hiecm/v3/api/p2)

[Error codes](/docs/main/docs/hiecm/v3/api/p2/errors)

[What each code P2 returns actually means, and the first thing to check when you see one.](/docs/main/docs/hiecm/v3/api/p2/errors)

## In short

- Discovery is for facilities the user visited without giving an ABHA address, and for old records.
- A [HIP](/docs/main/docs/hiecm/v3/getting-started/glossary#hip) is expected to answer a discovery request within 10 seconds.
- Never show a [care context](/docs/main/docs/hiecm/v3/getting-started/glossary#care-context) that is already linked.
...
3. Calls the [HIE-CM](/docs/main/docs/hiecm/v3/getting-started/glossary#hie-cm) to share the details.
...
Counter names arrive in the QR code: up to 20 alphanumeric characters, no special characters. A counter name cannot be the facility ID, the [HPID](/docs/main/docs/hiecm/v3/getting-started/glossary#hpid), the HIP ID or the HIP name.
...
The user selects care contexts and confirms. The HIP sends an [OTP](/docs/main/docs/hiecm/v3/getting-started/glossary#otp) to the registered mobile number, and on successful verification the care contexts link to the ABHA address.
...
An uploaded record is shareable once you hold three things: a link token from the M1 APIs, a care context added by HIP initiated linking from [M2 Attach](/docs/main/docs/hiecm/v3/milestones/m2), and the M2 health information transfer APIs.
...
- The calls and base URLs: [P2 API reference](/docs/main/docs/hiecm/v3/api/p2).
- The next milestone: [P3 Consent and notifications](/docs/main/docs/hiecm/v3/milestones/p3).
