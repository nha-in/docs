...
Support patient registration through QR-based workflows and generate service or queue identifiers in accordance with organization-specific processes. This use case sits beside [M1 Create](/docs/main/docs/hiecm/v3/milestones/m1): it uses the ABHA the person already holds.
