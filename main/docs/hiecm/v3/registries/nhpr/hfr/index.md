...
[HFR](/docs/main/docs/hiecm/v3/getting-started/glossary#hfr) is the Health Facility Registry, the places half of [NHPR](/docs/main/docs/hiecm/v3/registries/nhpr) alongside the [HPR](/docs/main/docs/hiecm/v3/registries/nhpr/hpr). It is a national directory of hospitals, clinics, diagnostic laboratories, imaging centres and pharmacies, and a facility has to enrol here before it can do anything else on [ABDM](/docs/main/docs/hiecm/v3/getting-started/glossary#abdm).

## Why it blocks everything else

A facility needs a valid facility ID and registration in the [HIP](/docs/main/docs/hiecm/v3/getting-started/glossary#hip) role before it can create health records and share them. A product that has finished [M2](/docs/main/docs/hiecm/v3/api/m2) or [M3](/docs/main/docs/hiecm/v3/api/m3) against the sandbox cannot go live without this registry.
...
Which parts of the detailed layer are mandatory depends on the facility type, the type of service and the system of medicine, and the rules are on [the HPR and HFR call list](/docs/main/docs/hiecm/v3/api/m4/undocumented). Two of them shape your form. An inpatient or day care facility must submit at least one bed count greater than zero. An imaging centre, diagnostic laboratory, blood bank or pharmacy need not submit medical infrastructure at all.
...
Both come from a person, not from your application. That is why [HPR](/docs/main/docs/hiecm/v3/registries/nhpr/hpr) comes first in a rollout, and why somebody in your organisation needs an [HPID](/docs/main/docs/hiecm/v3/getting-started/glossary#hpid) with facility manager rights, role 2 or role 3, before you write a line of HFR code.
...
| Send and validate OTP to contact | Sends an [OTP](/docs/main/docs/hiecm/v3/getting-started/glossary#otp) to the mobile number registered against a facility, then validates it. This proves control of a facility record you did not create |

Base URLs for every call on this page are on [NHPR](/docs/main/docs/hiecm/v3/registries/nhpr).
...
- [the HPR and HFR call list](/docs/main/docs/hiecm/v3/api/m4/undocumented), parameter tables and `HIS-` error codes.
- [M2 Attach, Health Information Provider Services](/docs/main/docs/hiecm/v3/api/m2), which needs this facility ID.
