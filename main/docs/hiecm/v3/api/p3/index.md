...
P3 is the other side of [M3](/docs/main/docs/hiecm/v3/api/m3). M3 is a requester asking for records; P3 is the patient deciding.
...
The full operation list is in the [P3 PHR consent and notifications API reference](/docs/main/reference/hiecm-p3).
