...
Every Milestone 4 call for the [HPR](/docs/main/docs/hiecm/v3/getting-started/glossary#hpr) and the [HFR](/docs/main/docs/hiecm/v3/getting-started/glossary#hfr), with its parameters, its codes and the rules that apply to it. Two operations carry a published path and have their own pages under APIs. The rest are here.
...
The first call you make. Same session pattern as [M1](/docs/main/docs/hiecm/v3/api/m1), issued by the [HIE-CM](/docs/main/docs/hiecm/v3/getting-started/glossary#hie-cm) gateway.
...
Both hosts are listed under [Base URLs](/docs/main/docs/hiecm/v3/api/m4#base-urls).
...
Three fields below are sent encrypted: the mobile number in mobile match, the [OTP](/docs/main/docs/hiecm/v3/getting-started/glossary#otp) in the HPR mobile login, and the email and password in create HPID. All use the same public certificate, so fetch it once.
...
| 4    | Check HPID exists by Aadhaar        | Returns the [HPID](/docs/main/docs/hiecm/v3/getting-started/glossary#hpid) already registered for this Aadhaar, if there is one                     | Behaviour only    |
...
| `hipName`      | Yes      | The name a patient sees in their [ABHA](/docs/main/docs/hiecm/v3/getting-started/glossary#abha) or [PHR](/docs/main/docs/hiecm/v3/getting-started/glossary#phr) app. 15 characters or fewer, no special characters, unique for every bridge on a facility |
| `type`         | Yes      | `HIP` or `HIU`                                                                                                                                                                                                                                            |
...
- The interactive reference: [M4 API reference](/docs/main/reference/hiecm-m4).
- The order of calls, as diagrams: [M4 user journeys](/docs/main/docs/hiecm/v3/milestones/m4).
- A path missing here that you need now: ask on [support](/docs/main/docs/support).
