...
- Each NHCX API module has its own index at `/docs/nhcx/v1/api/<module>/llms.txt`. [API references](/docs/main/docs/nhcx/v1/api) names the modules.
...
In Claude Code the portal's `nhcx` plugin carries all seven. Add the portal's marketplace as [Install the plugin](/docs/main/docs/hiecm/v3/getting-started/build-with-ai#install-the-plugin) shows, then run `claude plugin install nhcx@abdm-portal`.
