...
[Fetch participants list in the API reference](/docs/main/docs/nhcx/v1/api/registry/endpoints/registry-fetch-participants-list)
...
[Get beneficiary policies in the API reference](/docs/main/docs/nhcx/v1/api/registry/endpoints/registry-participant-get-policies)
...
2. [Coverage eligibility](/docs/main/docs/nhcx/v1/roles/provider/registration-and-eligibility) with purpose `discovery`, to learn the active policy code from the payer.
...
[Link ABHA number to policies in the API reference](/docs/main/docs/nhcx/v1/api/registry/endpoints/registry-participant-link-abha-policy)
...
[De-link ABHA policies in the API reference](/docs/main/docs/nhcx/v1/api/registry/endpoints/registry-participant-delink-abha-policy)
