...
[Participant create (v1) in the API reference](/docs/main/docs/nhcx/v1/api/onboarding/endpoints/onboarding-participant-create)
...
[Participant update (v1) in the API reference](/docs/main/docs/nhcx/v1/api/registry/endpoints/registry-participant-update)
