...
[Build it well](/docs/main/docs/nhcx/v1/getting-started/build-it-well) is new. It covers who refused a message, which sends are safe to repeat, how to match an answer to its request, and what to do when no answer comes.
