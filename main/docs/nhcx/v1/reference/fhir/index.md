...
- [Preauthorisation request](/docs/main/docs/nhcx/v1/reference/fhir/preauthorisation-request)
...
- [Insurance plan response, package-based](/docs/main/docs/nhcx/v1/reference/fhir/insurance-plan-response-package-based)
- [Insurance plan response, coverage-based](/docs/main/docs/nhcx/v1/reference/fhir/insurance-plan-response-coverage-based)
