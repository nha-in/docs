...
Reply: [C2. Coverage Eligibility Verdict](../callbacks/C2-coverage-eligibility-on-check.md), C3. Authorisation Requirements Ruling (in nhcx-preauth), C4. Insurance Plan Reply (in nhcx-preauth), C5. Pre-auth Reply (in nhcx-preauth), C6. Claim Reply (in nhcx-claim), C7. Cancel Reply (in nhcx-preauth), C8. Enquiry Reply (in nhcx-preauth).
...
Data: [D1. organization](../database/D1-organization.md), D18. claim_preauth (in nhcx-preauth), D20. claim_submission (in nhcx-preauth).
