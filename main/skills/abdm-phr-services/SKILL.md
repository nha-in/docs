...
This file is a snapshot. Re-download it from https://nha-in.github.io/docs/main/skills/abdm-phr-services/SKILL.md when it is older than the work you are doing.
