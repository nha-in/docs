...
- [Receiving a callback](/docs/pr-41/docs/nhcx/v1/getting-started/receiving-a-callback)
- [Get your sandbox credentials](/docs/pr-41/docs/nhcx/v1/getting-started/get-your-sandbox-credentials)
- [PMJAY sandbox run](/docs/pr-41/docs/nhcx/v1/roles/provider/pmjay-sandbox-run)
- [PMJAY adjudication APIs](/docs/pr-41/docs/nhcx/v1/roles/provider/pmjay-adjudication-apis)

The whole specification, with a request you can send from the page, is the [PMJAY adjudicator API reference](/docs/pr-41/reference/nhcx-adjudicator).
