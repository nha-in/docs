...
[M1 IdentityCreate and verify ABHA](/docs/pr-41/docs/hiecm/v3/milestones/m1)[M2 Health Information ProviderCreate and link records](/docs/pr-41/docs/hiecm/v3/milestones/m2)[M3 Health Information UserFetch data with consent](/docs/pr-41/docs/hiecm/v3/milestones/m3)[M4 Registry IntegrationRegister facilities and professionals](/docs/pr-41/docs/hiecm/v3/milestones/m4)

Three workflows sit on top of the milestones and start at your counter QR code. [Scan and Register](/docs/pr-41/docs/hiecm/v3/use-cases/scan-and-register) belongs to M1, [Patient record share](/docs/pr-41/docs/hiecm/v3/use-cases/patient-record-share) to M3 and [Scan and Pay](/docs/pr-41/docs/hiecm/v3/use-cases/scan-and-pay) to M2. All are under [Use cases](/docs/pr-41/docs/hiecm/v3/use-cases).
...
1. Milestone 1 · IdentityRegister Meera's ABHA
   ...
   [Build M1](/docs/pr-41/docs/hiecm/v3/milestones/m1)
...
2. Milestone 2 · Health Information ProviderAttach today's visit to her ABHA
   ...
   [Build M2](/docs/pr-41/docs/hiecm/v3/milestones/m2)
...
3. Milestone 3 · Health Information UserRetrieve the scan from another hospital
   ...
   [Build M3](/docs/pr-41/docs/hiecm/v3/milestones/m3)
...
1. PHR 1 · Identity and profileMeera signs up and holds her own profile
   ...
   [Build P1](/docs/pr-41/docs/hiecm/v3/milestones/p1)
...
2. PHR 2 · Linking and recordsShe finds records she never linked
   ...
   [Build P2](/docs/pr-41/docs/hiecm/v3/milestones/p2)
...
3. PHR 3 · Consent and notificationsShe decides who sees what
   ...
   [Build P3](/docs/pr-41/docs/hiecm/v3/milestones/p3)
...
| **Health Information User**, such as an insurer, a referral service or an analytics service. May request and view health records held by another entity after receiving the individual's consent. | Required                                                        | Not needed                                                      | The bulk of your build                                          | [Confirm at onboarding](/docs/pr-41/docs/hiecm/v3/concepts/participants/insurer#confirm-at-onboarding) |
| **Personal Health Record Application.** Enables individuals to manage their ABHA details, discover and link health records, and control consent for sharing them.                                 | [P1](/docs/pr-41/docs/hiecm/v3/milestones/p1), the patient side | [P2](/docs/pr-41/docs/hiecm/v3/milestones/p2), the patient side | [P3](/docs/pr-41/docs/hiecm/v3/milestones/p3), the patient side | Not needed                                                                                             |

## What each milestone gets you

| Milestone                                                                                                       | What you get                                | Who needs it                                                   |
| --------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | -------------------------------------------------------------- |
| [M1 Identity: ABHA Creation and Verification](/docs/pr-41/docs/hiecm/v3/milestones/m1)                          | Identity and the session token              | Everyone                                                       |
| [M2 Health Information Provider: Health Information Provider Services](/docs/pr-41/docs/hiecm/v3/milestones/m2) | Linking and sharing records                 | A facility publishing records, and a citizen pushing their own |
| [M3 Health Information User: Health Information User Services](/docs/pr-41/docs/hiecm/v3/milestones/m3)         | Consent and record fetching                 | Anyone reading records they did not create, and every PHR app  |
| [M4 Registry Integration: National Healthcare Providers Registry](/docs/pr-41/docs/hiecm/v3/milestones/m4)      | A facility ID and professional registration | Anyone going live as a facility                                |

These pages give the steps, the order to build them in and the failure modes. Every request URL, header and body sits on the [API reference](/docs/pr-41/docs/hiecm/v3/api) pages, one page per call.

## Next

Start with [M1 Identity](/docs/pr-41/docs/hiecm/v3/milestones/m1), or read [Go live](/docs/pr-41/docs/hiecm/v3/getting-started/going-live) for what happens after the fourth certificate.
