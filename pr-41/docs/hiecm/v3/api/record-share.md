...
[Collection](/docs/pr-41/postman/hiecm-record-share.postman_collection.json)[Environment](/docs/pr-41/postman/hiecm-sandbox.postman_environment.json)

`https://nha-in.github.io/docs/pr-41/postman/hiecm-record-share.postman_collection.json`
...
The full operation list is in the [record share API reference](/docs/pr-41/reference/hiecm-record-share).
