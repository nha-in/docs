...
[Collection](/docs/pr-41/postman/hiecm-p2.postman_collection.json)[Environment](/docs/pr-41/postman/hiecm-sandbox.postman_environment.json)

`https://nha-in.github.io/docs/pr-41/postman/hiecm-p2.postman_collection.json`
...
The full operation list is in the [P2 Consents Management API reference](/docs/pr-41/reference/hiecm-p2).

New to this? Start with [P2 Linking and records](/docs/pr-41/docs/hiecm/v3/milestones/p2).
