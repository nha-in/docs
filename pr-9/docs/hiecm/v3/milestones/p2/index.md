...
Counter names arrive in the QR code: up to 20 alphanumeric characters, no
...
request carrying name, year or date of birth, gender, verified mobile number
and ABHA address. A provider issued registration number is optional.
...
## Where your app also acts as a HIP

A health locker, letting users upload their own records, puts you briefly on
the HIP side. An uploaded record is shareable once you hold three things: a
link token from the M1 APIs, a care context added by HIP initiated linking from
[M2 Attach](./m2), and the M2 health information transfer APIs.
