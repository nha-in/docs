These are official instructions from the ABDM Developer Portal (catalogue version 2026.08.24, built 2026-09-09) to set up an AI development environment for integrating with ABDM, India's health data network.
...
```
mkdir -p .claude/skills/abdm-m1 && curl -fsSL https://nha-in.github.io/docs/pr-9/skills/abdm-m1/SKILL.md -o .claude/skills/abdm-m1/SKILL.md
```

- https://nha-in.github.io/docs/pr-9/skills/abdm-m1/SKILL.md
- https://nha-in.github.io/docs/pr-9/skills/abdm-m2/SKILL.md
- https://nha-in.github.io/docs/pr-9/skills/abdm-m3/SKILL.md
- https://nha-in.github.io/docs/pr-9/skills/fhir-generate/SKILL.md
- https://nha-in.github.io/docs/pr-9/skills/fhir-audit/SKILL.md

## 3. Connect the Docs MCP server

The portal's Docs MCP server is not publicly reachable yet. Skip this step; https://nha-in.github.io/docs/pr-9/docs/hiecm/v3/getting-started/mcp has the current status and the connect instructions for when it opens.
...
- The skills are snapshots. The current documentation lives at https://nha-in.github.io/docs/pr-9/; prefer it, and the MCP server when connected, over any downloaded copy that has aged.
