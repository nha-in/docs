...
What exists today, counted from the repository rather than from intent: `catalogue/openapi/hiecm/v3/` holds nine OpenAPI specifications carrying 289 operations between them, the gateway plus M1, M2, M3, M4, P1, P2, P3 and PHR application services. The site renders 348 HIE-CM pages, 302 of them generated from those specifications, alongside 16 UHI pages and 5 NHCX pages.
...
|---|---|---|---|
| HIE-CM (ABDM V3) M1, M2, M3 | **Phase 1, atoms written** | `hiecm-m1.yaml`, `hiecm-m2.yaml` and `hiecm-m3.yaml`, 44, 16 and 12 operations. 120 atoms across the three milestones. 3 of them are verified, all 3 on M1. The other 117 are unverified. | All five dummy-proof sections on every atom. Every endpoint curl verified against sandbox. Every NHA functional test case is an atom. All nine skills compile and pass validation. First-day developer test passes for M1 (§9). |
