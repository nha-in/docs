...
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [HIE-CM](/docs/pr-18/docs/hiecm/v3/getting-started/glossary#hie-cm) | Care seeker ([ABHA](/docs/pr-18/docs/hiecm/v3/getting-started/glossary#abha)) and care provider ([HPR](/docs/pr-18/docs/hiecm/v3/getting-started/glossary#hpr), [HFR](/docs/pr-18/docs/hiecm/v3/getting-started/glossary#hfr)) identities, care contexts, consent and health records |
| [UHI](/docs/pr-18/docs/uhi/v1)                                      | Unified Health Interface: discovery and delivery of digital health services through an open and interoperable network                                                                                                                                                                |
| [NHCX](/docs/pr-18/docs/nhcx/v1)                                    | National Health Claims Exchange: standardised exchange of health insurance claim information among payers, healthcare providers, beneficiaries, third-party administrators and other participating entities                                                                          |

Your work on HIE-CM is four milestones, and they spell [CARE](/docs/pr-18/docs/hiecm/v3/milestones): Create the identity, Attach your records to it, Retrieve records held elsewhere, Enrol your facility and your professionals.
...
More ways to set one up are on [Build with AI](/docs/pr-18/docs/hiecm/v3/getting-started/build-with-ai).

## Start building

[Get your sandbox credentials](/docs/pr-18/docs/hiecm/v3/getting-started/sandbox)

[Register and get a client id and secret.](/docs/pr-18/docs/hiecm/v3/getting-started/sandbox)

[Quickstart](/docs/pr-18/docs/hiecm/v3/getting-started/first-fifteen-minutes)

[Create your first test ABHA live, with your own credentials.](/docs/pr-18/docs/hiecm/v3/getting-started/first-fifteen-minutes)

[Milestones](/docs/pr-18/docs/hiecm/v3/milestones)

[The four milestones and what each one gets you.](/docs/pr-18/docs/hiecm/v3/milestones)

[Build with AI](/docs/pr-18/docs/hiecm/v3/getting-started/build-with-ai)

[Skills, MCP server and prompts for your coding agent.](/docs/pr-18/docs/hiecm/v3/getting-started/build-with-ai)

[Go live](/docs/pr-18/docs/hiecm/v3/getting-started/going-live)

[What certification and the exit process involve.](/docs/pr-18/docs/hiecm/v3/getting-started/going-live)

[Fix what broke](/docs/pr-18/docs/hiecm/v3/troubleshooting)

[Start from the symptom you are seeing, not the error code.](/docs/pr-18/docs/hiecm/v3/troubleshooting)

## Common use cases

[I want to create an ABHA](/docs/pr-18/docs/hiecm/v3/milestones/m1)

[Identity for every patient, created and verified.](/docs/pr-18/docs/hiecm/v3/milestones/m1)

[I want to share health records](/docs/pr-18/docs/hiecm/v3/milestones/m2)

[Link care contexts and serve them under consent.](/docs/pr-18/docs/hiecm/v3/milestones/m2)

[I want to read records held elsewhere](/docs/pr-18/docs/hiecm/v3/milestones/m3)

[Request consent, fetch and decrypt.](/docs/pr-18/docs/hiecm/v3/milestones/m3)

[I want to build a patient's health app](/docs/pr-18/docs/hiecm/v3/milestones/p1)

[ABHA login, record discovery, consent control.](/docs/pr-18/docs/hiecm/v3/milestones/p1)

[I want to register a facility or professional](/docs/pr-18/docs/hiecm/v3/milestones/m4)

[Get the ids every call needs.](/docs/pr-18/docs/hiecm/v3/milestones/m4)

## More resources

[Explore every API](/docs/pr-18/docs/hiecm/v3/api)

[The full reference, with try-it.](/docs/pr-18/docs/hiecm/v3/api)

[How consent works](/docs/pr-18/docs/hiecm/v3/concepts/consent)

[The one concept you must understand.](/docs/pr-18/docs/hiecm/v3/concepts/consent)
