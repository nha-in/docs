...
|                    |                                                                                                                                                                                          |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/communication/request` [`apis/07-communication/v1-communication-request.bru`](/docs/pr-23/docs/nhcx/v1/api/communication/endpoints/communication-v1-communication-request)          |
| **Callback**       | `/v1/communication/on_request` [`apis/07-communication/v1-communication-on-request.bru`](/docs/pr-23/docs/nhcx/v1/api/communication/endpoints/communication-v1-communication-on-request) |
...
|                    |                                                                                                                                                                                          |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/communication/on_request` [`apis/07-communication/v1-communication-on-request.bru`](/docs/pr-23/docs/nhcx/v1/api/communication/endpoints/communication-v1-communication-on-request) |
| **Callback**       | `/v1/communication/request` [`apis/07-communication/v1-communication-request.bru`](/docs/pr-23/docs/nhcx/v1/api/communication/endpoints/communication-v1-communication-request)          |
