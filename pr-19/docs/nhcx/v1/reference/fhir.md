...
- [Insurance plan response, package-based](/docs/pr-19/docs/nhcx/v1/reference/fhir/insurance-plan-response-package-based)
- [Insurance plan response, coverage-based](/docs/pr-19/docs/nhcx/v1/reference/fhir/insurance-plan-response-coverage-based)
