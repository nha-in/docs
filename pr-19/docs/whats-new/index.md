...
- [NHCX error pages list their codes](/docs/pr-19/docs/whats-new/2026-09-21#nhcx-error-pages-list-their-codes)
- [The NHCX plugin installs](/docs/pr-19/docs/whats-new/2026-09-21#the-nhcx-plugin-installs)
- [NHCX skills install as a folder](/docs/pr-19/docs/whats-new/2026-09-21#nhcx-skills-install-as-a-folder)
- [Build it well, for NHCX](/docs/pr-19/docs/whats-new/2026-09-21#build-it-well-for-nhcx)

## 16 September 2026

3 changes

- [The API reference follows the specifications of 16 September 2026](/docs/pr-19/docs/whats-new/2026-09-16#the-api-reference-follows-the-specifications-of-16-september-2026)
- [Each ABHA creation and login method is its own sequence](/docs/pr-19/docs/whats-new/2026-09-16#each-abha-creation-and-login-method-is-its-own-sequence)
- [Error pages list the codes the specifications return](/docs/pr-19/docs/whats-new/2026-09-16#error-pages-list-the-codes-the-specifications-return)
