...
[Biometric auth init in the API reference](/docs/pr-28/docs/nhcx/v1/api/biometric/endpoints/biometric-auth-init)
...
[Biometric auth verify in the API reference](/docs/pr-28/docs/nhcx/v1/api/biometric/endpoints/biometric-auth-verify)
...
[Face auth init in the API reference](/docs/pr-28/docs/nhcx/v1/api/biometric/endpoints/biometric-faceauth-init)
...
[Face auth capture PID in the API reference](/docs/pr-28/docs/nhcx/v1/api/biometric/endpoints/biometric-faceauth-capture-pid)
...
[Face auth verify in the API reference](/docs/pr-28/docs/nhcx/v1/api/biometric/endpoints/biometric-faceauth-v2-auth-verify)
...
[Biometric auth refresh token in the API reference](/docs/pr-28/docs/nhcx/v1/api/biometric/endpoints/biometric-auth-refresh-token)
