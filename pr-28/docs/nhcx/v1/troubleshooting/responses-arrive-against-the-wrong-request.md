...
An answer lands on the wrong case in your system. Or the exchange refuses a request as a duplicate, or refuses a callback it cannot match. All three come from how your system sets and reads the [correlation ID](/docs/pr-28/docs/nhcx/v1/getting-started/glossary#messages) and the [API call ID](/docs/pr-28/docs/nhcx/v1/getting-started/glossary#messages).
...
- [Envelope Fields](/docs/pr-28/docs/nhcx/v1/reference/envelope-fields): every identifier on the envelope, and when each one changes.
- [JWE, Status and Errors](/docs/pr-28/docs/nhcx/v1/concepts/jwe-status-and-errors): how a cycle threads from request to answer.
