...
| Status, reprocess, release (A6) | each enquiry `asking` | that enquiry's `txn_id` | newest inbound carrying a `Task` | C8. Enquiry Reply (in nhcx-preauth) |
...
Rows: `claim` ([D9](../database/D9-claim.md)), `claim_plan` (D10 (in nhcx-preauth)), `claim_auth` (D13 (in nhcx-coverage)), `claim_preauth` (D18 (in nhcx-preauth)), `claim_predetermination` (D19 (in nhcx-preauth)), `claim_submission` (D20 (in nhcx-preauth)), `claim_enquiry` (D29 (in nhcx-preauth)).
...
#### A10U. USED BY
- APIs: [A11. Transaction Dispatch](A11-txn-dispatch.md), [A12. Transaction FHIR](A12-txn-fhir.md), [A13. Transaction List](A13-txn-list.md), [A17. Claim State](A17-claim-state.md)
