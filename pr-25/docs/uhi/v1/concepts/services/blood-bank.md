...
Blood bank discovery is the smallest service on [UHI](/docs/pr-25/docs/uhi/v1/getting-started/glossary#uhi): one call pair. Your app sends a search with a blood group, a component and a location, and gets back blood banks with unit counts, addresses and phone numbers.
...
| Role                                                          | What it does                                                                                   |
| ------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| [EUA](/docs/pr-25/docs/uhi/v1/getting-started/glossary#eua)   | A patient or clinician facing app. Sends searches, receives results at its callback URL        |
| [HSPA](/docs/pr-25/docs/uhi/v1/getting-started/glossary#hspa) | A blood bank management system or aggregator. Answers searches from its own inventory database |
...
| 2    | [Gateway](/docs/pr-25/docs/uhi/v1/getting-started/glossary#gateway) | Returns HTTP 200 with an acknowledgement. This confirms receipt only   |
...
- [ABDM](/docs/pr-25/docs/uhi/v1/getting-started/glossary#abdm) [M2](/docs/pr-25/docs/hiecm/v3/api/m2) with [HIE-CM](/docs/pr-25/docs/uhi/v1/getting-started/glossary#hie-cm) completed. This is a hard prerequisite for any UHI service.
