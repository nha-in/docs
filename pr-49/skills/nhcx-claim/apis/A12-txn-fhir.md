...
Reply: C2. Coverage Eligibility Verdict (in nhcx-coverage), C3. Authorisation Requirements Ruling (in nhcx-preauth), C4. Insurance Plan Reply (in nhcx-preauth), C5. Pre-auth Reply (in nhcx-preauth), [C6. Claim Reply](../callbacks/C6-claim-on-submit.md), C7. Cancel Reply (in nhcx-preauth), [C8. Enquiry Reply](../callbacks/C8-enquiry-on-submit.md).
...
#### A12U. USED BY
- APIs: [A5. Claim Submit](A5-claim-submit.md), [A6. Task Submit (cancel, status, reprocess, release)](A6-task-submit.md), [A10. Transaction Related](A10-txn-related.md), [A13. Transaction List](A13-txn-list.md), [A17. Claim State](A17-claim-state.md)
