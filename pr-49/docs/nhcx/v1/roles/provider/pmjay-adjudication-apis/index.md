...
[Adjudicator: get the user role for a case in the API reference](/docs/pr-49/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-pmjay-sbxhcx-nhcxpayerservice-v1-get-user-role)
...
[Adjudicator: act on a case in the API reference](/docs/pr-49/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-pmjay-hcx-nhcxpayerservice-wrapper-process-case)
