...
- [Claim request](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-request)
- [Claim query and answer](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
...
- [Preauthorisation query and answer](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
- [Claim response](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-response)
- [Claim query and answer](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
...
- [Insurance plan response](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-response-overview)
- [Insurance plan response, package-based](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-response-package-based)
- [Insurance plan response, coverage-based](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-response-coverage-based)
...
- [Claim query and answer](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Cancel, reprocess and shortfall](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall)
- [Payment notice and acknowledgement](/docs/pr-49/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement)
- [Communication](/docs/pr-49/docs/nhcx/v1/reference/fhir/communication)
- [Status and search](/docs/pr-49/docs/nhcx/v1/reference/fhir/status-and-search)
...
- [Insurance plan request](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-request)
- [Preauthorisation query and answer](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
- [Claim query and answer](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Cancel, reprocess and shortfall](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall)
- [Payment notice and acknowledgement](/docs/pr-49/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement)
