...
API call[`/fetch/participants/list`API reference](/docs/pr-49/docs/nhcx/v1/api/registry/endpoints/registry-fetch-participants-list)
...
API call[`/participant/get/policies`API reference](/docs/pr-49/docs/nhcx/v1/api/registry/endpoints/registry-participant-get-policies)
...
API call[`/fetch/certs`API reference](/docs/pr-49/docs/nhcx/v1/api/registry/endpoints/registry-fetch-certs)
...
API call[`/get/session`API reference](/docs/pr-49/docs/nhcx/v1/api/registry/endpoints/registry-get-session)
...
- **FHIR Reference:** [Status and Search, A5](/docs/pr-49/docs/nhcx/v1/reference/fhir/status-and-search#a5-get-status-shared)

Where any request you made got to, by its correlation id. The sandbox's own status page answers without a token.

API call[`/v1/status`API reference](/docs/pr-49/docs/nhcx/v1/api/status/endpoints/status-v1-status)

Callback[`/v1/on_status`API reference](/docs/pr-49/docs/nhcx/v1/api/other/endpoints/other-webhook-v1-on-status)
...
Callback[`/v1/error`API reference](/docs/pr-49/docs/nhcx/v1/api/other/endpoints/other-webhook-v1-error)
...
- **Workflow ID:** None
- **FHIR Reference:** [Coverage Eligibility Request, B1](/docs/pr-49/docs/nhcx/v1/reference/fhir/coverage-eligibility-request#b1-check-coverage-eligibility-provider)
...
API call[`/v1/coverageeligibility/check`API reference](/docs/pr-49/docs/nhcx/v1/api/eligibility/endpoints/eligibility-v1-coverageeligibility-check)

Callback[`/v1/coverageeligibility/on_check`API reference](/docs/pr-49/docs/nhcx/v1/api/eligibility/endpoints/eligibility-webhook-v1-coverageeligibility-on-check)
...
- **FHIR Reference:** [Insurance Plan Request, B2](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-request#b2-request-insurance-plan-provider)
...
API call[`/v1/insuranceplan/request`API reference](/docs/pr-49/docs/nhcx/v1/api/insurance-plan/endpoints/insurance-plan-v1-insuranceplan-request)

Callback[`/v1/insuranceplan/on_request`API reference](/docs/pr-49/docs/nhcx/v1/api/insurance-plan/endpoints/insurance-plan-webhook-v1-insuranceplan-on-request)
...
- **Workflow ID:** [`12`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=12#every-workflow-code), [`121`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=121#every-workflow-code), [`13`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=13#every-workflow-code), [`19`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=19#every-workflow-code), [`131`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=131#every-workflow-code)
- **FHIR Reference:** [Preauthorisation Request, B3](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-request#b3-submit-pre-authorisation-provider)
...
API call[`/v1/preauth/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/preauth/endpoints/preauth-v1-preauth-submit)

Callback[`/v1/preauth/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/preauth/endpoints/preauth-webhook-v1-preauth-on-submit)
...
- **Workflow ID:** [`24`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=24#every-workflow-code), [`241`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=241#every-workflow-code), [`27`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=27#every-workflow-code)
- **FHIR Reference:** [Communication, B4](/docs/pr-49/docs/nhcx/v1/reference/fhir/communication#b4-respond-to-a-communication-provider)
...
API call[`/v1/communication/on_request`API reference](/docs/pr-49/docs/nhcx/v1/api/communication/endpoints/communication-v1-communication-on-request)

Callback[`/v1/communication/request`API reference](/docs/pr-49/docs/nhcx/v1/api/communication/endpoints/communication-webhook-v1-communication-request)
...
- **Workflow ID:** [`15`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=15#every-workflow-code), [`161`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=161#every-workflow-code), [`14`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=14#every-workflow-code)
- **FHIR Reference:** [Claim Request, B5](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-request#b5-submit-claim-provider)
...
API call[`/v1/claim/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/claim/endpoints/claim-v1-claim-submit)

Callback[`/v1/claim/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/claim/endpoints/claim-webhook-v1-claim-on-submit)
...
- **FHIR Reference:** [Status and Search, B6](/docs/pr-49/docs/nhcx/v1/reference/fhir/status-and-search#b6-search-claims-provider)
...
API call[`/v1/search/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/status/endpoints/status-v1-search-submit)

Callback[`/v1/search/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/status/endpoints/status-webhook-v1-search-on-submit)
...
- **Workflow ID:** [`30`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=30#every-workflow-code), [`17`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=17#every-workflow-code)
- **FHIR Reference:** [Payment Notice and Acknowledgement, B7](/docs/pr-49/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement#b7-acknowledge-payment-notice-provider)
...
API call[`/v1/paymentnotice/on_request`API reference](/docs/pr-49/docs/nhcx/v1/api/payment-notice/endpoints/payment-notice-v1-paymentnotice-on-request)

Callback[`/v1/paymentnotice/request`API reference](/docs/pr-49/docs/nhcx/v1/api/payment-notice/endpoints/payment-notice-webhook-v1-paymentnotice-request)
...
- **Workflow ID:** [`PC01`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=PC01#every-workflow-code), [`36`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=36#every-workflow-code)
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, B8](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#b8-reprocess-or-cancel-provider)
...
API call[`/v1/task/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/task/endpoints/task-v1-task-submit)

Callback[`/v1/task/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/task/endpoints/task-webhook-v1-task-on-submit)
...
- **FHIR Reference:** [Insurance Plan Request, D1](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-request#d1-fetch-the-insurance-plan-pmjay)
...
- **FHIR Reference:** [Coverage Eligibility Request, D3](/docs/pr-49/docs/nhcx/v1/reference/fhir/coverage-eligibility-request#d3-check-coverage-eligibility-pmjay)
...
- **Workflow ID:** [`12`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=12#every-workflow-code)
- **FHIR Reference:** [Preauthorisation Request, D4](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-request#d4-submit-pre-authorisation-pmjay)
...
- **Workflow ID:** [`121`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=121#every-workflow-code)
- **FHIR Reference:** [Preauthorisation Request, D5](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-request#d5-resubmit-pre-authorisation-pmjay)
...
- **Workflow ID:** [`13`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=13#every-workflow-code), [`131`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=131#every-workflow-code), [`241`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=241#every-workflow-code)
- **FHIR Reference:** [Preauthorisation Enhancement, D6](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-enhancement#d6-raise-an-enhancement-pmjay)
...
- **Workflow ID:** [`19`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=19#every-workflow-code)
- **FHIR Reference:** [Preauthorisation Query and Answer, D7](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer#d7-answer-a-pre-authorisation-query-pmjay)
...
- **Workflow ID:** [`PC01`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=PC01#every-workflow-code)
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, D8](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#d8-cancel-pre-authorisation-pmjay)
...
- **Workflow ID:** [`15`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=15#every-workflow-code)
- **FHIR Reference:** [Claim Request, D9](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-request#d9-submit-claim-pmjay)
...
- **Workflow ID:** [`161`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=161#every-workflow-code)
- **FHIR Reference:** [Claim Query and Answer, D10](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-query-and-answer#d10-answer-a-claim-query-pmjay)
...
- **Workflow ID:** [`36`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=36#every-workflow-code)
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, D11](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#d11-reprocess-a-rejected-claim-pmjay)
...
- **Workflow ID:** [`36`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=36#every-workflow-code)
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, D12](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#d12-claim-a-shortfall-pmjay)
...
- **Workflow ID:** [`17`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=17#every-workflow-code)
- **FHIR Reference:** [Payment Notice and Acknowledgement, D13](/docs/pr-49/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement#d13-acknowledge-the-payment-notice-pmjay)
...
API call[`/participant/link/abha/policy`API reference](/docs/pr-49/docs/nhcx/v1/api/registry/endpoints/registry-participant-link-abha-policy)
...
API call[`/participant/delink/abha/policy`API reference](/docs/pr-49/docs/nhcx/v1/api/registry/endpoints/registry-participant-delink-abha-policy)
...
- **FHIR Reference:** [Coverage Eligibility Response, C3](/docs/pr-49/docs/nhcx/v1/reference/fhir/coverage-eligibility-response#c3-respond-to-coverage-eligibility-payer)
...
API call[`/v1/coverageeligibility/on_check`API reference](/docs/pr-49/docs/nhcx/v1/api/eligibility/endpoints/eligibility-v1-coverageeligibility-on-check)

Callback[`/v1/coverageeligibility/check`API reference](/docs/pr-49/docs/nhcx/v1/api/eligibility/endpoints/eligibility-webhook-v1-coverageeligibility-check)
...
- **FHIR Reference:** [Insurance Plan Response Overview, C4](/docs/pr-49/docs/nhcx/v1/reference/fhir/insurance-plan-response-overview#c4-respond-to-insurance-plan-request-payer)
...
API call[`/v1/insuranceplan/on_request`API reference](/docs/pr-49/docs/nhcx/v1/api/insurance-plan/endpoints/insurance-plan-v1-insuranceplan-on-request)

Callback[`/v1/insuranceplan/request`API reference](/docs/pr-49/docs/nhcx/v1/api/insurance-plan/endpoints/insurance-plan-webhook-v1-insuranceplan-request)
...
- **Workflow ID:** [`20`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=20#every-workflow-code), [`21`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=21#every-workflow-code), [`23`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=23#every-workflow-code), [`24`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=24#every-workflow-code), [`22`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=22#every-workflow-code), [`231`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=231#every-workflow-code), [`241`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=241#every-workflow-code)
- **FHIR Reference:** [Preauthorisation Response, C5](/docs/pr-49/docs/nhcx/v1/reference/fhir/preauthorisation-response#c5-respond-to-pre-authorisation-payer)
...
API call[`/v1/preauth/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/preauth/endpoints/preauth-v1-preauth-on-submit)

Callback[`/v1/preauth/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/preauth/endpoints/preauth-webhook-v1-preauth-submit)
...
- **Workflow ID:** [`24`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=24#every-workflow-code), [`241`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=241#every-workflow-code), [`27`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=27#every-workflow-code), [`N02`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=N02#every-workflow-code)
- **FHIR Reference:** [Communication, C6](/docs/pr-49/docs/nhcx/v1/reference/fhir/communication#c6-raise-a-communication-payer)
...
API call[`/v1/communication/request`API reference](/docs/pr-49/docs/nhcx/v1/api/communication/endpoints/communication-v1-communication-request)

Callback[`/v1/communication/on_request`API reference](/docs/pr-49/docs/nhcx/v1/api/communication/endpoints/communication-webhook-v1-communication-on-request)
...
- **Workflow ID:** [`25`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=25#every-workflow-code), [`26`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=26#every-workflow-code), [`27`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=27#every-workflow-code), [`28`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=28#every-workflow-code), [`29`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=29#every-workflow-code), [`291`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=291#every-workflow-code)
- **FHIR Reference:** [Claim Response, C7](/docs/pr-49/docs/nhcx/v1/reference/fhir/claim-response#c7-respond-to-claim-payer)
...
API call[`/v1/claim/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/claim/endpoints/claim-v1-claim-on-submit)

Callback[`/v1/claim/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/claim/endpoints/claim-webhook-v1-claim-submit)

C8Respond to search

Returns the claims that match a search.

- **FHIR Reference:** [Status and Search, C8](/docs/pr-49/docs/nhcx/v1/reference/fhir/status-and-search#c8-respond-to-search-payer)

The ClaimResponse objects matching the criteria asked for.

API call[`/v1/search/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/status/endpoints/status-v1-search-on-submit)

Callback[`/v1/search/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/status/endpoints/status-webhook-v1-search-submit)
...
- **Workflow ID:** [`30`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=30#every-workflow-code), [`31`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=31#every-workflow-code), [`33`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=33#every-workflow-code)
- **FHIR Reference:** [Payment Notice and Acknowledgement, C9](/docs/pr-49/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement#c9-send-payment-notice-payer)
...
API call[`/v1/paymentnotice/request`API reference](/docs/pr-49/docs/nhcx/v1/api/payment-notice/endpoints/payment-notice-v1-paymentnotice-request)

Callback[`/v1/paymentnotice/on_request`API reference](/docs/pr-49/docs/nhcx/v1/api/payment-notice/endpoints/payment-notice-webhook-v1-paymentnotice-on-request)

C10Respond to a Task

Answers an appeal, a request for the rest of a part-paid claim, or a cancellation.

- **Workflow ID:** [`252`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=252#every-workflow-code), [`253`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=253#every-workflow-code), [`254`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=254#every-workflow-code), [`PC02`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=PC02#every-workflow-code), [`37`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=37#every-workflow-code)
- **FHIR Reference:** [Cancel, Reprocess and Shortfall, C10](/docs/pr-49/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall#c10-respond-to-a-task-payer)
...
API call[`/v1/task/on_submit`API reference](/docs/pr-49/docs/nhcx/v1/api/task/endpoints/task-v1-task-on-submit)

Callback[`/v1/task/submit`API reference](/docs/pr-49/docs/nhcx/v1/api/task/endpoints/task-webhook-v1-task-submit)
...
- **Workflow ID:** [`N01`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=N01#every-workflow-code), [`N02`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=N02#every-workflow-code), [`N03`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=N03#every-workflow-code), [`N04`](/docs/pr-49/docs/nhcx/v1/concepts/workflow-codes?code=N04#every-workflow-code)
...
API call[`/v1/notification/subscribe`API reference](/docs/pr-49/docs/nhcx/v1/api/other/endpoints/other-v1-notification-subscribe)

Callback[`/v1/notification/on_subscribe`API reference](/docs/pr-49/docs/nhcx/v1/api/other/endpoints/other-v1-notification-on-subscribe)
