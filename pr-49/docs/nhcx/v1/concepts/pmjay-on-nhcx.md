...
[Scheme rules the HMIS must implement](/docs/pr-49/docs/nhcx/v1/concepts/pmjay-use-cases#scheme-rules-the-hmis-must-implement), in PMJAY use cases, gives the codes, fields, tariffs and error codes behind each rule.
