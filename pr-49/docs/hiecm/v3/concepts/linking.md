...
| [Discovery](/docs/pr-49/docs/hiecm/v3/getting-started/glossary#discovery) and link | The patient goes looking for old records from their PHR app         | The patient               |
...
- [M2 Health Information Provider, Health Information Provider Services](/docs/pr-49/docs/hiecm/v3/api/m2), the call order for all three routes.
