...
- [the HPR and HFR call list](/docs/pr-49/docs/hiecm/v3/api/m4), with parameter tables.
- [M2 Health Information Provider: Create and link records](/docs/pr-49/docs/hiecm/v3/api/m2), which needs this facility ID.
