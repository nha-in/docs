...
[M1 IdentityCreate and verify ABHA](/docs/pr-49/docs/hiecm/v3/milestones/m1)[M2 Health Information ProviderCreate and link records](/docs/pr-49/docs/hiecm/v3/milestones/m2)[M3 Health Information UserFetch data with consent](/docs/pr-49/docs/hiecm/v3/milestones/m3)[M4 Registry IntegrationRegister facilities and professionals](/docs/pr-49/docs/hiecm/v3/milestones/m4)

Three workflows sit on top of the milestones and start at your counter QR code. [Scan and Register](/docs/pr-49/docs/hiecm/v3/use-cases/scan-and-register) belongs to M1, [Patient record share](/docs/pr-49/docs/hiecm/v3/use-cases/patient-record-share) to M3 and [Scan and Pay](/docs/pr-49/docs/hiecm/v3/use-cases/scan-and-pay) to M2. All are under [Use cases](/docs/pr-49/docs/hiecm/v3/use-cases).
...
1. Milestone 1 · IdentityRegister Meera's ABHA
   ...
   [Build M1](/docs/pr-49/docs/hiecm/v3/milestones/m1)
...
2. Milestone 2 · Health Information ProviderAttach today's visit to her ABHA
   ...
   [Build M2](/docs/pr-49/docs/hiecm/v3/milestones/m2)
...
3. Milestone 3 · Health Information UserRetrieve the scan from another hospital
   ...
   [Build M3](/docs/pr-49/docs/hiecm/v3/milestones/m3)
...
4. Milestone 4 · Registry IntegrationEnrol the clinic and its doctors
   ...
   [Build M4](/docs/pr-49/docs/hiecm/v3/milestones/m4)
...
| **Health Information User**, such as an insurer, a referral service or an analytics service. May request and view health records held by another entity after receiving the individual's consent. | Required                                                        | Not needed                                                      | The bulk of your build                                          | [Confirm at onboarding](/docs/pr-49/docs/hiecm/v3/concepts/participants/insurer#confirm-at-onboarding) |
| **Personal Health Record Application.** Enables individuals to manage their ABHA details, discover and link health records, and control consent for sharing them.                                 | [P1](/docs/pr-49/docs/hiecm/v3/milestones/p1), the patient side | [P2](/docs/pr-49/docs/hiecm/v3/milestones/p2), the patient side | [P3](/docs/pr-49/docs/hiecm/v3/milestones/p3), the patient side | Not needed                                                                                             |
...
Start with [M1 Identity](/docs/pr-49/docs/hiecm/v3/milestones/m1), or read [Go live](/docs/pr-49/docs/hiecm/v3/getting-started/going-live) for what happens after the fourth certificate.
