...
Data: the leg's row supplies `correlation_id` and the send time: [D9. claim](../database/D9-claim.md), D10. claim_plan (in nhcx-preauth), D13. claim_auth (in nhcx-coverage), D18. claim_preauth (in nhcx-preauth), D19. claim_predetermination (in nhcx-preauth), [D20. claim_submission](../database/D20-claim-submission.md), D29. claim_enquiry (in nhcx-preauth).
