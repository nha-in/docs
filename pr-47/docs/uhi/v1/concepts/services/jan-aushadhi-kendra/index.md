...
| ------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [EUA](/docs/pr-47/docs/uhi/v1/getting-started/glossary#eua)         | You, or any [PHR](/docs/pr-47/docs/uhi/v1/getting-started/glossary#phr) app | Sends the `search`. Receives the `on_search` on your callback URL. Renders the Kendra list. |
...
| [HSPA](/docs/pr-47/docs/uhi/v1/getting-started/glossary#hspa)       | PMBI, the Pharmaceuticals and Medical Devices Bureau of India               | Queries the PMBI Kendra database. Builds the `on_search` catalog.                           |

You do not build a [HSPA](/docs/pr-47/docs/uhi/v1/getting-started/glossary#hspa) unless you are PMBI or their technology partner.
...
- Searching for a medicine, then for the Kendras that stock it: [Jan Aushadhi medicine search](/docs/pr-47/docs/uhi/v1/concepts/services/jan-aushadhi-medicine-search)
