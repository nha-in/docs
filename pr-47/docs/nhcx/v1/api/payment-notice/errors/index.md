...
| Code                                                                               | What it means                                                                                       |
| ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| [`PAYR-1020`](/docs/pr-47/docs/nhcx/v1/reference/pmjay-error-codes?code=PAYR-1020) | The payer holds no valid bank details for your facility, or a supporting info category is not valid |
