...
[Biometric auth init in the API reference](/docs/pr-47/docs/nhcx/v1/api/biometric/endpoints/biometric-hcx-abha-biometric-auth-init)
...
[Biometric auth verify in the API reference](/docs/pr-47/docs/nhcx/v1/api/biometric/endpoints/biometric-hcx-abha-biometric-auth-verify)
...
[Face auth init in the API reference](/docs/pr-47/docs/nhcx/v1/api/biometric/endpoints/biometric-pmjay-sbxhcx-abdmproxy-abha-biometric-faceauth-init)
...
[Face auth capture PID in the API reference](/docs/pr-47/docs/nhcx/v1/api/biometric/endpoints/biometric-pmjay-sbxhcx-abdmproxy-abha-biometric-capture-pid)
...
[Face auth verify in the API reference](/docs/pr-47/docs/nhcx/v1/api/biometric/endpoints/biometric-pmjay-sbxhcx-abdmproxy-abha-biometric-v2-auth-verify)
...
[Biometric auth refresh token in the API reference](/docs/pr-47/docs/nhcx/v1/api/biometric/endpoints/biometric-hcx-abha-biometric-auth-refresh-token)
