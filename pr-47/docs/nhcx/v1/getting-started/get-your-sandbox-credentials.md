...
Every National Health Claims Exchange (NHCX) call carries a session token, and every token starts with an [ABDM](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) client ID and client secret. This chapter gets you those credentials, your NHCX sandbox roles, and a payer to test against.

## In short

- Register your organisation first: a hospital in the [Health Facility Registry (HFR)](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#identity-and-registration), an insurer or [TPA](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) with its [IRDAI](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) registry id.
- Apply for ABDM sandbox credentials, then register the same client on the NHCX sandbox.
- Your software must support ABDM [Milestone 1](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#identity-and-registration), [ABHA](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#identity-and-registration) creation and verification.
- Test against the [dummy payer](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#messages), participant code `1000003538@hcx`.
...
| Preauthorisation or claim | Send the submit, then choose its answer with the [dummy payer action call](/docs/pr-47/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-process-request): `Approve`, `Reject` or `Query`. |
| Payment notice            | Start it with the [payment notice trigger](/docs/pr-47/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-paymentnotice-init).                                                              |

The provider id and policy number apply to the dummy payer only. Codes such as `100001@sbx` and `1000002090@hcx` in examples show the format. Before you address any other code, look it up in [the participant list](/docs/pr-47/docs/nhcx/v1/api/registry/endpoints/registry-fetch-participants-list).

## What you see when it works

- A [session token call](/docs/pr-47/docs/nhcx/v1/getting-started/session-token) with your client ID and secret returns an access token.
- The NHCX sandbox registration form is submitted, and roles are assigned to your client.
- [Fetching the certificate](/docs/pr-47/docs/nhcx/v1/getting-started/fetching-a-recipient-certificate) of `1000003538@hcx` returns a PEM certificate.
...
| Topic                                                                                                                                                                                                                      | Write to                         |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| Fast Healthcare Interoperability Resources (FHIR) bundle validation at sandbox exit, and the internal and [Health Tech Committee (HTC)](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#identity-and-registration) demos | `hcx.integration@nha.gov.in`     |
| Building a FHIR bundle, and the [NRCeS](/docs/pr-47/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) specifications                                                                                     | `nrc-help@cdac.in`               |
...
- [Quickstart](/docs/pr-47/docs/nhcx/v1/getting-started/quickstart): your first three calls, with nothing but these credentials.
- [Base URLs](/docs/pr-47/docs/nhcx/v1/getting-started/base-urls): every address in the sandbox and in production.
- [Creating and Updating a Participant](/docs/pr-47/docs/nhcx/v1/getting-started/creating-and-updating-a-participant): your own participant code.
