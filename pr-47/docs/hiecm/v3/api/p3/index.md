...
The full operation list is in the [P3 Subscription API reference](/docs/pr-47/reference/hiecm-p3).

New to this? Start with [P3 Consent and notifications](/docs/pr-47/docs/hiecm/v3/milestones/p3).
