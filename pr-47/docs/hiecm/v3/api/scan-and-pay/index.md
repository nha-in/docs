...
The full operation list is in the [Scan and Pay API reference](/docs/pr-47/reference/hiecm-scan-and-pay).

New to this? Start with [Scan and Pay](/docs/pr-47/docs/hiecm/v3/use-cases/scan-and-pay).
