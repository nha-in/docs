...
`https://nha-in.github.io/docs/pr-47/postman/hiecm-p2.postman_collection.json`
...
The full operation list is in the [P2 Consents Management API reference](/docs/pr-47/reference/hiecm-p2).

New to this? Start with [P2 Linking and records](/docs/pr-47/docs/hiecm/v3/milestones/p2).
