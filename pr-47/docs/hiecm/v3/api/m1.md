...
[See the user journeyWhat the person experiences, screen by screen, before you write any code.](/docs/pr-47/docs/hiecm/v3/milestones/m1)[When it goes wrongThe recorded error shapes and codes, and what to do about each.](/docs/pr-47/docs/hiecm/v3/api/m1/errors)

New to this? Start with [M1 Identity](/docs/pr-47/docs/hiecm/v3/milestones/m1).
