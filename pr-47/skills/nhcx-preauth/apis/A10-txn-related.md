...
#### A10U. USED BY
- Screens: [S7. Insurance Plan](../screens/S7-insurance-plan.md), [S8. Line Items](../screens/S8-line-items.md), [S9. Pre-authorisation](../screens/S9-preauthorisation.md)
- APIs: [A2. Coverage Eligibility Check](A2-coverage-eligibility-check.md), [A3. Insurance Plan Request](A3-insurance-plan-request.md), [A4. Pre-auth Submit](A4-preauth-submit.md), [A6. Task Submit (cancel, status, reprocess, release)](A6-task-submit.md), [A11. Transaction Dispatch](A11-txn-dispatch.md), [A12. Transaction FHIR](A12-txn-fhir.md), [A13. Transaction List](A13-txn-list.md), [A17. Claim State](A17-claim-state.md)
