...
#### F17U. USED BY
- APIs: [A5. Claim Submit](../apis/A5-claim-submit.md), [A6. Task Submit (cancel, status, reprocess, release)](../apis/A6-task-submit.md)
- Callbacks: [C6. Claim Reply](../callbacks/C6-claim-on-submit.md), [C8. Enquiry Reply](../callbacks/C8-enquiry-on-submit.md)
- FHIR: [F8. Claim](F8-claim.md), [F10. Task (claim actions)](F10-task-claim-actions.md), [F18. Coverage](F18-coverage.md), [F19. Other bundle resources](F19-other-resources.md)
