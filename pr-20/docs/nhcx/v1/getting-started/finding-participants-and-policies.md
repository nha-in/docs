...
[Fetch participants list in the API reference](/docs/pr-20/docs/nhcx/v1/api/registry/endpoints/registry-fetch-participants-list)
...
[Get beneficiary policies in the API reference](/docs/pr-20/docs/nhcx/v1/api/registry/endpoints/registry-participant-get-policies)
...
[Link ABHA number to policies in the API reference](/docs/pr-20/docs/nhcx/v1/api/registry/endpoints/registry-participant-link-abha-policy)
...
[De-link ABHA policies in the API reference](/docs/pr-20/docs/nhcx/v1/api/registry/endpoints/registry-participant-delink-abha-policy)
