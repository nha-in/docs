...
If M2 is not done, start at [M2 Attach, Health Information Provider Services](/docs/pr-20/docs/hiecm/v3/api/m2).
...
- [M2 Attach, Health Information Provider Services](/docs/pr-20/docs/hiecm/v3/api/m2), the prerequisite
