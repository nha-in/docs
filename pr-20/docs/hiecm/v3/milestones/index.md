...
[M1 CreateABHA Creation and Verification](/docs/pr-20/docs/hiecm/v3/milestones/m1)[M2 AttachHealth Information Provider Services](/docs/pr-20/docs/hiecm/v3/milestones/m2)[M3 RetrieveHealth Information User Services](/docs/pr-20/docs/hiecm/v3/milestones/m3)[M4 EnrolNational Healthcare Providers Registry](/docs/pr-20/docs/hiecm/v3/milestones/m4)
...
1. Milestone 1 · CreateRegister Meera's ABHA
   ...
   [Build M1 Create](/docs/pr-20/docs/hiecm/v3/milestones/m1)
...
2. Milestone 2 · AttachAttach today's visit to her ABHA
   ...
   [Build M2 Attach](/docs/pr-20/docs/hiecm/v3/milestones/m2)
...
3. Milestone 3 · RetrieveRetrieve the scan from another hospital
   ...
   [Build M3 Retrieve](/docs/pr-20/docs/hiecm/v3/milestones/m3)
...
4. Milestone 4 · EnrolEnrol the clinic and its doctors
   ...
   [Build M4 Enrol](/docs/pr-20/docs/hiecm/v3/milestones/m4)
...
| ------------------------------------------------------------------------------------------- | ------------------------------------------- | -------------------------------------------------------------- |
| [M1 Create: ABHA Creation and Verification](/docs/pr-20/docs/hiecm/v3/milestones/m1)        | Identity and the session token              | Everyone                                                       |
| [M2 Attach: Health Information Provider Services](/docs/pr-20/docs/hiecm/v3/milestones/m2)  | Linking and sharing records                 | A facility publishing records, and a citizen pushing their own |
| [M3 Retrieve: Health Information User Services](/docs/pr-20/docs/hiecm/v3/milestones/m3)    | Consent and record fetching                 | Anyone reading records they did not create, and every PHR app  |
| [M4 Enrol: National Healthcare Providers Registry](/docs/pr-20/docs/hiecm/v3/milestones/m4) | A facility ID and professional registration | Anyone going live as a facility                                |
...
Start with [M1 Create](/docs/pr-20/docs/hiecm/v3/milestones/m1), or read [Go live](/docs/pr-20/docs/hiecm/v3/getting-started/going-live) for what happens after the fourth certificate.
