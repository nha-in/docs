...
The two calls: [receive a patient's shared profile](/docs/pr-20/docs/hiecm/v3/api/m2/endpoints/m2-callbacks/08-m2-post-v3-hip-patient-share) and [send the share acknowledgement](/docs/pr-20/docs/hiecm/v3/api/m2/endpoints/m2-abdm-patient-share-hip/01-m2-post-patient-share-v3-on-share). The patient's side is [P2 Linking and records](/docs/pr-20/docs/hiecm/v3/milestones/p2#scan-and-share-at-a-facility).
