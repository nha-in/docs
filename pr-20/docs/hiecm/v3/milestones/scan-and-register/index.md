...
Support patient registration through QR-based workflows and generate service or queue identifiers in accordance with organization-specific processes. This use case sits beside [M1 Create](/docs/pr-20/docs/hiecm/v3/milestones/m1): it uses the ABHA the person already holds.
...
The two calls: [receive a patient's shared profile](/docs/pr-20/docs/hiecm/v3/api/m2/endpoints/m2-abdm-patient-share-hip/01-m2-post-v3-hip-patient-share) and [send the share acknowledgement](/docs/pr-20/docs/hiecm/v3/api/m2/endpoints/m2-abdm-patient-share-hip/02-m2-post-patient-share-v3-on-share). The patient's side is [P2 Linking and records](/docs/pr-20/docs/hiecm/v3/milestones/p2#scan-and-share-at-a-facility).
