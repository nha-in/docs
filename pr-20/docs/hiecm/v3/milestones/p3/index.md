...
2. Set up an auto approval policy with the [HIE-CM](/docs/pr-20/docs/hiecm/v3/getting-started/glossary#hie-cm).
...
5. The [HIP](/docs/pr-20/docs/hiecm/v3/getting-started/glossary#hip) sends the records across the network.
6. Your app stores them for long term access and displays them, preferably in chronological order.

## Next

- The calls and base URLs: [P3 API reference](/docs/pr-20/reference/hiecm-p3).
- Back to the four provider milestones: [Milestones](/docs/pr-20/docs/hiecm/v3/milestones).
