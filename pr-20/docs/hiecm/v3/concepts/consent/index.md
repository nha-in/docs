...
- [M3 Retrieve, Health Information User Services](/docs/pr-20/docs/hiecm/v3/api/m3), the requesting side.
- [M2 Attach, Health Information Provider Services](/docs/pr-20/docs/hiecm/v3/api/m2), what a record holder validates.
