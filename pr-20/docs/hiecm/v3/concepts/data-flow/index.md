...
- [M2 Attach, Health Information Provider Services](/docs/pr-20/docs/hiecm/v3/api/m2), the sending side.
- [M3 Retrieve, Health Information User Services](/docs/pr-20/docs/hiecm/v3/api/m3), the receiving side.
