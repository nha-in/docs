...
You do not link a record. You link a [care context](/docs/pr-20/docs/hiecm/v3/getting-started/glossary#care-context), a group of a patient's records that your system defines. It carries two fields and nothing else.
