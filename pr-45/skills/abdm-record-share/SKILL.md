...
This file is a snapshot. Re-download the whole folder from https://nha-in.github.io/docs/pr-45/skills/abdm-record-share/ when it is older than the work you are doing: this router and every file under references/ that it links to. Fetching this file alone leaves those links pointing at files you do not have.
...
## What you can do with Patient scan and record share

- Record share, PHR app side
- Record share, HIU side
...
- **Integrate.** 12 operations, with their hosts and headers. [references/integrate.md](references/integrate.md)
...
- Every endpoint, with its body fields and responses: /docs/hiecm/v3/api/record-share
