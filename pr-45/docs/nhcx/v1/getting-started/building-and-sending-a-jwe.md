...
Every field, its obligation and its allowed values are in [The JWE message format](/docs/pr-45/docs/nhcx/v1/getting-started/jwe-message-format).
...
[Pre-authorisation submit in the API reference](/docs/pr-45/docs/nhcx/v1/api/preauth/endpoints/preauth-v1-preauth-submit)
