...
`https://nha-in.github.io/docs/pr-45/postman/hiecm-scan-and-pay.postman_collection.json`
...
The full operation list is in the [Scan and Pay API reference](/docs/pr-45/reference/hiecm-scan-and-pay).

New to this? Start with [Scan and Pay](/docs/pr-45/docs/hiecm/v3/use-cases/scan-and-pay).
