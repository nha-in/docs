...
Physical consultation is the fullest service on [UHI](/docs/pr-16/docs/uhi/v1/getting-started/glossary#uhi). A patient searches for a doctor, then sees real slots and fees from clinics they have no prior relationship with. They book one, and receive a 4-digit PIN to present at the clinic. After this page you will know the four stages, the endpoints each role exposes, and the fields on every call, as [NHA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#nha) documents them.

Read [UHI services](/docs/pr-16/docs/uhi/v1) first, for the `context` block, the acknowledgement model, signing and the two transports.
...
| Actor                                                               | Role here                                                                                                           |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| [EUA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#eua)         | The patient facing app. Searches, books, shows the PIN and the status.                                              |
| [HSPA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#hspa)       | The provider platform. Holds doctor profiles and slots, confirms bookings, generates the PIN, drives the lifecycle. |
| HSP                                                                 | The hospital, clinic or doctor. The HSPA is its digital interface.                                                  |
| [Gateway](/docs/pr-16/docs/uhi/v1/getting-started/glossary#gateway) | The routing layer. Involved in discovery only.                                                                      |
...
| `fulfillment.agent.id`             | string   | No          | Doctor [HPR](/docs/pr-16/docs/uhi/v1/getting-started/glossary#hpr) address, for example `<HPR_ADDRESS>` |
...
| `order.customer.id`                      | Yes         | Patient [ABHA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#abha) address, for example `rahul.k001@sbx` |
...
- [UHI services](/docs/pr-16/docs/uhi/v1) for the shared protocol
- [Ambulance booking](/docs/pr-16/docs/uhi/v1/concepts/services/ambulance-booking)
- [Blood bank](/docs/pr-16/docs/uhi/v1/concepts/services/blood-bank)
- [M2](/docs/pr-16/docs/hiecm/v3/api/m2), the prerequisite
- [Support](/docs/pr-16/docs/support)
