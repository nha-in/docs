...
This is the two step version of Jan Aushadhi discovery: your user searches for a medicine by name, then you search again for the Kendras that carry it, with a stock flag on each. After this page you will know what changes from [Jan Aushadhi Kendra discovery](/docs/pr-16/docs/uhi/v1/concepts/services/jan-aushadhi-kendra), which is `fulfillment.type` and `item.descriptor` and nothing else.

## Who does what

The same three parties as every [UHI](/docs/pr-16/docs/uhi/v1/getting-started/glossary#uhi) service. Your app is the [EUA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#eua). [NHA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#nha) runs the Gateway. PMBI runs the [HSPA](/docs/pr-16/docs/uhi/v1/getting-started/glossary#hspa) that holds the medicine and stock data. Signing, onboarding and the Gateway base URLs are on [UHI services](/docs/pr-16/docs/uhi/v1).
...
Change `fulfillment.type` to `JANAUSHADHI_KENDRA` and put the `medicineId` in `item.descriptor`. Add whichever location filter your user chose: state and district, pincode, or GPS and radius. The filter fields are the same as on [Jan Aushadhi Kendra discovery](/docs/pr-16/docs/uhi/v1/concepts/services/jan-aushadhi-kendra).
...
Every other field on the provider record is documented in the [Kendra discovery field reference](/docs/pr-16/docs/uhi/v1/concepts/services/jan-aushadhi-kendra#field-reference).
...
- Kendra discovery without a medicine filter: [Jan Aushadhi Kendra discovery](/docs/pr-16/docs/uhi/v1/concepts/services/jan-aushadhi-kendra)
