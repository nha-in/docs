...
- The counterparty is the sandbox [dummy payer](/docs/pr-16/docs/nhcx/v1/getting-started/glossary#messages), `1000003538@hcx`.

## Prerequisites

- An [ABDM](/docs/pr-16/docs/nhcx/v1/getting-started/glossary#organisations-and-programmes) sandbox client ID and client secret, with NHCX sandbox roles assigned. [Get your sandbox credentials](/docs/pr-16/docs/nhcx/v1/getting-started/get-your-sandbox-credentials) if you do not have them.
...
[Session token in the API reference](/docs/pr-16/docs/nhcx/v1/api/session/endpoints/session-session-token)
...
[Participant search in the API reference](/docs/pr-16/docs/nhcx/v1/api/registry/endpoints/registry-participant-search)
...
[Fetch certificate in the API reference](/docs/pr-16/docs/nhcx/v1/api/registry/endpoints/registry-fetch-certs)
...
A token that every NHCX call accepts, a counterparty you know is on the network, and the key that seals its messages. Those are items 1, 4 and 5 of [the base framework](/docs/pr-16/docs/nhcx/v1/getting-started/the-base-framework).
...
| No entry for the code              | The code is wrong or not registered                                            | Pick it again from [the participant list](/docs/pr-16/docs/nhcx/v1/api/registry/endpoints/registry-fetch-participants-list) |

## Next steps

- [Your Certificate](/docs/pr-16/docs/nhcx/v1/getting-started/your-certificate): make your own key pair, the counterpart of the one step 3 fetched.
- [Creating and Updating a Participant](/docs/pr-16/docs/nhcx/v1/getting-started/creating-and-updating-a-participant): register your certificate and callback address.
- [Building and Sending a JWE](/docs/pr-16/docs/nhcx/v1/getting-started/building-and-sending-a-jwe): seal a message with the certificate from step 3.
