...
Every health record that moves inside [ABDM](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#abdm) travels as a [FHIR](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#fhir) bundle, not a PDF in an envelope of your own design and not your database rows. This page gives the version, the profiles, the bundle shape and how to validate one; the packaging detail is in the [M2 guide](/docs/pr-16/docs/hiecm/v3/api/m2).
...
There are eight record types. Implementing all of them is mandatory for an [HMIS](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#hmis).

| Record type              | What it holds                                                                                                                               | [HI type](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#hi-type) code |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
...
| Wellness Record          | Vitals, physical examination and general health data, often captured in a [PHR](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#phr) app | `WellnessRecord`                                                           |
...
The reference service on the [HIU](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#hiu) side supports these resources inside a bundle.
...
| `Composition.attester.party`  | References an `Organization` whose `identifier.value` is the facility's [HIP](/docs/pr-16/docs/hiecm/v3/getting-started/glossary#hip) id as registered in the facility registry. Mode is `official`. |
...
- [M2 use cases](/docs/pr-16/reference/hiecm-m2), the transfer call that carries the encrypted bundle.
- [How a record travels](/docs/pr-16/docs/hiecm/v3/concepts/data-flow), what happens to the bundle after you build it.
- [Care contexts and linking](/docs/pr-16/docs/hiecm/v3/concepts/linking), how records are grouped and made findable.
- [Consent](/docs/pr-16/docs/hiecm/v3/concepts/consent), where the HI type codes above are chosen and read.
