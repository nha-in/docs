...
| Bridge linkage         | A link between a Facility ID and one or more bridges, each identified as a [HIP](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hip) or [HIU](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hiu) | A facility whose software is going live                                                                 |
| Search and master data | Facility search and nearby search                                                                                                                                                                         | Anyone building either of the above                                                                     |

## Intended users

- **Facilities going live.** A facility must be registered in the HFR and have a bridge linked to it to share health information as a HIP or retrieve it as an HIU. For facilities that have implemented [M2 Attach](/docs/pr-17/docs/hiecm/v3/milestones/m2) or [M3 Retrieve](/docs/pr-17/docs/hiecm/v3/milestones/m3), M4 is the next step towards production readiness.
...
- **Software acting for others.** An [HMIS](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hmis) or practice management product can drive these calls for its own customers.
...
[SKILL.md](/docs/pr-17/skills/abdm-m4/SKILL.md "The router. Use the command below to take the references with it.")
...
`mkdir -p .claude/skills/abdm-m4/references && curl -fsSL https://nha-in.github.io/docs/pr-17/skills/abdm-m4/SKILL.md -o .claude/skills/abdm-m4/SKILL.md && for f in scaffold integrate debug; do curl -fsSL https://nha-in.github.io/docs/pr-17/skills/abdm-m4/references/$f.md -o .claude/skills/abdm-m4/references/$f.md; done`

[Open in Claude](claude://code/new?q=Install%20the%20ABDM%20M4%20agent%20skill%20into%20this%20project%2C%20then%20help%20me%20use%20it.%0A%0ARun%20this%3A%0Amkdir%20-p%20.claude%2Fskills%2Fabdm-m4%2Freferences%20%26%26%20curl%20-fsSL%20https%3A%2F%2Fnha-in.github.io%2Fdocs%2Fpr-17%2Fskills%2Fabdm-m4%2FSKILL.md%20-o%20.claude%2Fskills%2Fabdm-m4%2FSKILL.md%20%26%26%20for%20f%20in%20scaffold%20integrate%20debug%3B%20do%20curl%20-fsSL%20https%3A%2F%2Fnha-in.github.io%2Fdocs%2Fpr-17%2Fskills%2Fabdm-m4%2Freferences%2F%24f.md%20-o%20.claude%2Fskills%2Fabdm-m4%2Freferences%2F%24f.md%3B%20done%0A%0AIf%20this%20session%20did%20not%20open%20in%20the%20repository%20I%20am%20integrating%20ABDM%20into%2C%20ask%20me%20for%20the%20path%20before%20you%20write%20anything.)
...
[Going live](/docs/pr-17/docs/hiecm/v3/getting-started/going-live) outlines the four steps involved and the requirements for each step.

## The journey, step by step

Milestone 4 of [ABDM](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#abdm) covers the following key journeys.

- **HPID creation and role selection.** A healthcare professional completes Aadhaar authentication and creates an [HPID](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hpid). The professional then selects the required role: [HPR](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hpr), [HFR](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hfr), or both.
...
- **Facility software integration.** A registered facility can link its bridge to the Facility ID, enabling it to publish health records as the [HIP](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hip) and retrieve records as the [HIU](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#hiu) through its software.
...
This page shows the order of calls in each. Field lists are in the [M4 API reference](/docs/pr-17/docs/hiecm/v3/api/m4).
...
The professional authenticates using Aadhaar. The integrating system does not handle the Aadhaar number or [OTP](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#otp). Instead, it handles the transaction ID and redirects the user to the URL returned by the HPR service.
...
A returning professional can also log in without Aadhaar authentication, using either a mobile OTP or a password. Both are under [HPR authentication](/docs/pr-17/docs/hiecm/v3/api/m4/endpoints/m4-authentication/01-m4-post-v1-auth-authpassword) in the M4 API reference.
...
- A single bridge can be linked to multiple facilities. See [one bridge, many facilities](/docs/pr-17/docs/hiecm/v3/concepts/how-it-fits#one-bridge-many-facilities).
...
The HIP name is the name displayed to patients in their [ABHA](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#abha) or [PHR](/docs/pr-17/docs/hiecm/v3/getting-started/glossary#phr) app when they search for a hospital. Three rules apply: a maximum of 15 characters, no special characters, and it must be unique for every bridge linked to the same facility. For example, the HIP name can be derived by combining the hospital name and the bridge name, while keeping to those rules.

A facility with a Facility ID and a linked HIP bridge can perform [M2](/docs/pr-17/docs/hiecm/v3/api/m2) activities, including linking care contexts and sharing health records. A facility with a linked HIU bridge can perform [M3](/docs/pr-17/docs/hiecm/v3/api/m3) activities, including requesting patient consent and fetching health records. M4 covers the registration of the facility and the healthcare professionals working at the facility.

Next: [M4 API reference](/docs/pr-17/docs/hiecm/v3/api/m4).

## Next

- The base URLs and the operation list: [M4 API reference](/docs/pr-17/docs/hiecm/v3/api/m4).
- The patient side of all four: [P1 Identity and profile](/docs/pr-17/docs/hiecm/v3/milestones/p1).
- Take your integration to production: [Go live](/docs/pr-17/docs/hiecm/v3/getting-started/going-live).
