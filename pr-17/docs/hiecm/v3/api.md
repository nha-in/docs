...
[Read the whole specification](/docs/pr-17/reference/hiecm-gateway)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-m1)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-m2)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-m3)

## M4 HPR and HFR

100 endpoints across 4 use cases: HPID, HFR, HRP bridge services, HPR. Each endpoint has its own page in the sidebar.

[Read the whole specification](/docs/pr-17/reference/hiecm-m4)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-p1)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-p2)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-p3)

## P4 Locker

4 endpoints across 1 use case: Locker. Each endpoint has its own page in the sidebar.

[Read the whole specification](/docs/pr-17/reference/hiecm-p4)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-subscription)
...
[Read the whole specification](/docs/pr-17/reference/hiecm-scan-and-pay)
...
| ---------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| M2 Linking and sharing | POST   | [`/api/v3/hip/patient/care-context/discover`](/docs/pr-17/docs/hiecm/v3/api/m2/endpoints/m2-abdm-user-initiated-linking-hip/01-m2-post-v3-hip-patient-care-context-discover) | This API endpoint is used to discover care contexts associated with a patient. It allows healthcare information providers (HIPs) to retrieve and manage patient care context information. |
| M2 Linking and sharing | POST   | [`/api/v3/hip/patient/share`](/docs/pr-17/docs/hiecm/v3/api/m2/endpoints/m2-abdm-patient-share-hip/01-m2-post-v3-hip-patient-share)                                          | This API will be invoked to the HIP for sharing the response of HIECM's /api/hiecm/patient-share/v3/share API                                                                             |
| Scan and Pay           | POST   | [`/v3/patient/share/open-order`](/docs/pr-17/docs/hiecm/v3/api/scan-and-pay/endpoints/scan-and-pay-abdm-scan-pay-hip/01-scan-and-pay-post-v3-patient-share-open-order)       | This is an API is called by HIU to check the status of reports.                                                                                                                           |
