...
- [The API reference follows the specifications of 16 September 2026](/docs/pr-17/docs/whats-new/2026-09-16#the-api-reference-follows-the-specifications-of-16-september-2026)
- [Each ABHA creation and login method is its own sequence](/docs/pr-17/docs/whats-new/2026-09-16#each-abha-creation-and-login-method-is-its-own-sequence)
- [Error pages list the codes the specifications return](/docs/pr-17/docs/whats-new/2026-09-16#error-pages-list-the-codes-the-specifications-return)
