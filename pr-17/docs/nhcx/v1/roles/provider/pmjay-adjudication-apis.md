...
[Adjudicator: role for a case in the API reference](/docs/pr-17/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-adjudicator-role)
...
[Adjudicator: act on a case in the API reference](/docs/pr-17/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-adjudicator-process)
