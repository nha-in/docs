...
- [Claim request](/docs/pr-17/docs/nhcx/v1/reference/fhir/claim-request)
- [Claim query and answer](/docs/pr-17/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Communication](/docs/pr-17/docs/nhcx/v1/reference/fhir/communication)
...
- [Preauthorisation query and answer](/docs/pr-17/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
- [Claim response](/docs/pr-17/docs/nhcx/v1/reference/fhir/claim-response)
- [Claim query and answer](/docs/pr-17/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
...
- [Insurance plan response, package-based](/docs/pr-17/docs/nhcx/v1/reference/fhir/insurance-plan-response-package-based)
- [Insurance plan response, coverage-based](/docs/pr-17/docs/nhcx/v1/reference/fhir/insurance-plan-response-coverage-based)
