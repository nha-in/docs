...
Contested in format and in zone, and [The JWE message format](/docs/pr-46/docs/nhcx/v1/getting-started/jwe-message-format) sets out the disagreement. Two facts settle part of it.
