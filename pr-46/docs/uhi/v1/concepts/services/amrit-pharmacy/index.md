...
Three parties. Shared roles, signing and onboarding are on [UHI services](/docs/pr-46/docs/uhi/v1).

| Party                                                               | Who runs it                                                                 | What it does here                                                      |
| ------------------------------------------------------------------- | --------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [EUA](/docs/pr-46/docs/uhi/v1/getting-started/glossary#eua)         | You, or any [PHR](/docs/pr-46/docs/uhi/v1/getting-started/glossary#phr) app | Sends the `search`. Receives the `on_search`. Renders the store list.  |
| [UHI](/docs/pr-46/docs/uhi/v1/getting-started/glossary#uhi) Gateway | [NHA](/docs/pr-46/docs/uhi/v1/getting-started/glossary#nha)                 | Validates and routes the `search`. Relays the `on_search` back to you. |
| [HSPA](/docs/pr-46/docs/uhi/v1/getting-started/glossary#hspa)       | HLL Lifecare Limited                                                        | Queries the AMRIT store database. Builds the `on_search` catalog.      |

You do not build a [HSPA](/docs/pr-46/docs/uhi/v1/getting-started/glossary#hspa) unless you are HLL or their technology partner.
...
Each `providers[]` entry is one AMRIT store. Three things here do not appear in other UHI services: the pharmacy type on the fulfillment, the store opening and closing times, and the [HFR](/docs/pr-46/docs/uhi/v1/getting-started/glossary#hfr) ID tag.
...
- The other pharmacy discovery service on UHI: [Jan Aushadhi Kendra discovery](/docs/pr-46/docs/uhi/v1/concepts/services/jan-aushadhi-kendra)
