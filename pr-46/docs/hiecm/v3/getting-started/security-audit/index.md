...
Every application passes a security audit before it reaches production. The audit is called a [WASA](/docs/pr-46/docs/hiecm/v3/getting-started/glossary#wasa), and it produces the [Safe to Host certificate](/docs/pr-46/docs/hiecm/v3/getting-started/glossary#safe-to-host-certificate) you upload with your exit form.
...
One audit covers one platform. An audit of a shared [ABHA](/docs/pr-46/docs/hiecm/v3/getting-started/glossary#abha) base URL does not cover the mobile applications that call it.
...
- Run the exit process this certificate feeds into: [Go live](/docs/pr-46/docs/hiecm/v3/getting-started/going-live).
- Ask about a certificate or an auditor: [Support](/docs/pr-46/docs/support).
