...
[Collection](/docs/pr-46/postman/hiecm-p3.postman_collection.json)[Environment](/docs/pr-46/postman/hiecm-sandbox.postman_environment.json)

`https://nha-in.github.io/docs/pr-46/postman/hiecm-p3.postman_collection.json`
...
The full operation list is in the [P3 Subscription API reference](/docs/pr-46/reference/hiecm-p3).

New to this? Start with [P3 Consent and notifications](/docs/pr-46/docs/hiecm/v3/milestones/p3).
