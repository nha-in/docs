...
#### F1U. USED BY
- APIs: [A2. Coverage Eligibility Check](../apis/A2-coverage-eligibility-check.md), [A12. Transaction FHIR](../apis/A12-txn-fhir.md)
...
- FHIR: [F2. CoverageEligibilityRequest](F2-coverage-eligibility-request.md), [F3. CoverageEligibilityResponse](F3-coverage-eligibility-response.md)
