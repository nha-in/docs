...
Reply: C2. Coverage Eligibility Verdict (in nhcx-coverage), [C3. Authorisation Requirements Ruling](../callbacks/C3-auth-requirements-on-check.md), [C4. Insurance Plan Reply](../callbacks/C4-insuranceplan-on-request.md), [C5. Pre-auth Reply](../callbacks/C5-preauth-on-submit.md), C6. Claim Reply (in nhcx-claim), [C7. Cancel Reply](../callbacks/C7-cancel-on-submit.md), [C8. Enquiry Reply](../callbacks/C8-enquiry-on-submit.md).
...
#### A12U. USED BY
- APIs: [A4. Pre-auth Submit](A4-preauth-submit.md), [A6. Task Submit (cancel, status, reprocess, release)](A6-task-submit.md), [A10. Transaction Related](A10-txn-related.md), [A13. Transaction List](A13-txn-list.md), [A17. Claim State](A17-claim-state.md)
