...
`https://nha-in.github.io/docs/pr-32/skills/index.json` lists every skill and the exact files it is made of, so fetch that first and work from it rather than guessing at reference names. For example:

```
mkdir -p .claude/skills/abdm-m1/references
curl -fsSL https://nha-in.github.io/docs/pr-32/skills/abdm-m1/SKILL.md -o .claude/skills/abdm-m1/SKILL.md
for f in scaffold integrate debug; do curl -fsSL https://nha-in.github.io/docs/pr-32/skills/abdm-m1/references/$f.md -o .claude/skills/abdm-m1/references/$f.md; done
```

- https://nha-in.github.io/docs/pr-32/skills/abdm-gateway/
- https://nha-in.github.io/docs/pr-32/skills/abdm-m1/
- https://nha-in.github.io/docs/pr-32/skills/abdm-m2/
- https://nha-in.github.io/docs/pr-32/skills/abdm-m3/
- https://nha-in.github.io/docs/pr-32/skills/abdm-m4/
- https://nha-in.github.io/docs/pr-32/skills/abdm-p1/
- https://nha-in.github.io/docs/pr-32/skills/abdm-p2/
- https://nha-in.github.io/docs/pr-32/skills/abdm-p3/
- https://nha-in.github.io/docs/pr-32/skills/abdm-p4/
- https://nha-in.github.io/docs/pr-32/skills/abdm-scan-and-register/
- https://nha-in.github.io/docs/pr-32/skills/abdm-scan-and-pay/
- https://nha-in.github.io/docs/pr-32/skills/abdm-record-share/
- https://nha-in.github.io/docs/pr-32/skills/abdm-fhir/
...
- The skills are snapshots. The current documentation lives at https://nha-in.github.io/docs/pr-32/; prefer it, and the MCP server when connected, over any downloaded copy that has aged.
