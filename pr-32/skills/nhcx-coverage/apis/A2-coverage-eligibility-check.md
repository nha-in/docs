...
Reply: [C2. Coverage Eligibility Verdict](../callbacks/C2-coverage-eligibility-on-check.md) (validation, benefits, discovery), C3. Authorisation Requirements Ruling (in nhcx-preauth) (auth-requirements)
