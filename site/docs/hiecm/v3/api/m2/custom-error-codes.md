---
title: M2 custom error codes
sidebar_label: Custom error codes
sidebar_position: 2
page_type: reference
description: The error codes an integrator may meet across discovery, linking, consent, encryption and data exchange, in one place.
source: Sandbox2.0 M2 and M3 API review v2 (NHA, 21 September 2026), "Error code put in one place for M2"
sidebar_class_name: sidebar-icon sidebar-icon--triangle-alert
---
