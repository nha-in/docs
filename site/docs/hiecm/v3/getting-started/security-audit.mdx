...
description: Pass the WASA security audit and hold a Safe to Host certificate, which every application needs before it runs in production.
verification: unverified
source: sandbox.abdm.gov.in/sandbox/v3/faq, cert-in.org.in/PDF/Empanel_org_2021.pdf
sidebar_position: 5
covers: [shared.sandbox.wasa]
---
