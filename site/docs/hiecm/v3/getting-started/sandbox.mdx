...
<SandboxAction action="credentials">View credentials in the sandbox</SandboxAction>
...
<SandboxAction action="callbackUrl">Register your callback URL</SandboxAction>
