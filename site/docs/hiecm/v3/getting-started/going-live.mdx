...
description: Stages 4 to 6 of sandbox integration. Functional testing and the security audit, the Health Tech Committee demonstration, then go live.
verification: unverified
source: NHA content review of 15 September 2026 (landing page, stages 4 to 6); abdm.gov.in/FAQ and sandbox.abdm.gov.in/docs/integration_and_exit_process for the exit form and the integration team demonstration
sidebar_position: 7
...
Working in the sandbox is not the same as being live. Stages 4 to 6 of
[sandbox integration](/docs/hiecm/v3/getting-started/sandbox#how-sandbox-integration-works)
sit between the two, and you run them once, at the end.

## In short

- Sandbox integration has 6 stages. Stages 1 to 3 get you access and build the
  milestones; this page covers stages 4 to 6.
...
Empanelled agencies run both. They are separate exercises with separate
outputs: functional testing produces a report and a certificate, and the
security audit produces the
...
Before testing, you demonstrate the [ABDM](/docs/hiecm/v3/getting-started/glossary#abdm)
functionality you built to the integration team.
...
Present the integrated solution to the
[Health Tech Committee](/docs/hiecm/v3/getting-started/glossary#health-tech-committee)
and obtain approval for production access. The committee records its decision in four
...
Production credentials are issued once the committee approves.

| What you call | Sandbox | Production |
| --- | --- | --- |
| The gateway | `https://dev.abdm.gov.in`, `X-CM-ID: sbx` | `https://apis.abdm.gov.in` |
| The [ABHA](/docs/hiecm/v3/getting-started/glossary#abha) service | `https://abhasbx.abdm.gov.in/abha/api/v3/` | Not in the specification |
