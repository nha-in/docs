...
You also need the Safe to Host certificate NHA requires before production. That security audit
is a separate exercise from anything functional, done by a CERT-In empanelled auditor, and it
