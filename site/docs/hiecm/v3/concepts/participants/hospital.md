...
search, and a numeric value such as `69765` on deduplicate search.
...
IDs, and registering the facility needs one of them.
...
- Answer [discovery](/docs/hiecm/v3/getting-started/glossary#discovery) when a
  patient comes looking from their app.
- Encrypt and push the records.
- Ask for a patient's history from another facility, under a consent they grant.

## Why it is worth it

A record you link appears in the patient's own app
