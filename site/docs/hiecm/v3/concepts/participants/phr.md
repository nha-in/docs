...
| [Phase 2 (P2)](/docs/hiecm/v3/milestones/p2) | Execution of facility-level Scan and Register, profile management, ABHA card and QR code generation, legacy record discovery, and standardized [Care Context](/docs/hiecm/v3/getting-started/glossary#care-context) linkage. |
