...
Registration and login are [P1](/docs/hiecm/v3/milestones/p1). The profile,
card and QR code are [P2](/docs/hiecm/v3/milestones/p2).
...
Set one up at two moments: when it creates an address
