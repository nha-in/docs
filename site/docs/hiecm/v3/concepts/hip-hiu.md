...
If your software creates health records for patients, [ABDM](/docs/hiecm/v3/getting-started/glossary#abdm) calls you a
[HIP](/docs/hiecm/v3/getting-started/glossary#hip), a health information provider. Your job has two halves: identify the
patient by their [ABHA](/docs/hiecm/v3/getting-started/glossary#abha) address at registration, which is
[M1](/docs/hiecm/v3/api/m1), and make the records you create discoverable and shareable, which is
...
- **HIU behaviour**, unless you also pull records from other facilities. That is
  [M3](/docs/hiecm/v3/api/m3), a separate integration.
...
- [M2 steps and calls](/docs/hiecm/v3/api/m2/sequence), what sandbox exit asks you to demonstrate.
