...
3. **Linking.** Two routes: HIP initiated with their ABHA
   ...
   at registration, valid 6 months, regenerated with the generate link token call. See [Care contexts and
...
Codes that cover its failures: `ABDM-1038` ABHA address and link token mismatch, `ABDM-1056` care context
already linked.
...
- [PHR applications](/docs/hiecm/v3/concepts/participants/phr), the other side of every flow here.
