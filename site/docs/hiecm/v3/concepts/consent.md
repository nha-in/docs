...
- [M3 Health Information User: Fetch data with consent](/docs/hiecm/v3/api/m3), the requesting side.
- [M2 Health Information Provider: Create and link records](/docs/hiecm/v3/api/m2), what a record holder validates.
