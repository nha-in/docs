...
description: Why a record has to be linked before anyone can find it, the two routes onto the map, and how the link token works.
...
| User initiated linking, by [discovery](/docs/hiecm/v3/getting-started/glossary#discovery) | The patient goes looking for earlier records from their PHR app | The patient |
...
- [M2 Health Information Provider: Create and link records](/docs/hiecm/v3/api/m2), the call order for both routes.
