---
title: M3 testing use cases
sidebar_label: M3 Retrieve
sidebar_position: 4
page_type: reference
description: The cases M3 is tested against. Raising a consent request, what comes back on each outcome, and revoking or expiring one.
