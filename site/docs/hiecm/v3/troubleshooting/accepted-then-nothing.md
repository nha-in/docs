...
[Discovery](/docs/hiecm/v3/getting-started/glossary#discovery) is the
patient, through a [PHR](/docs/hiecm/v3/getting-started/glossary#phr)
app, looking for the records your facility holds. Linking is you attaching a
...
3. **Link confirmation.** Do not treat the synchronous acknowledgement
   ...
   separate callback to your registered URL. See
...
covers registration and reachability.
