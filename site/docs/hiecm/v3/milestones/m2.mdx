...
subsequently made available in the patient's [PHR application](/docs/hiecm/v3/concepts/phr).
...
[PHR application](/docs/hiecm/v3/concepts/phr), the healthcare facility matches the respective demographic details
