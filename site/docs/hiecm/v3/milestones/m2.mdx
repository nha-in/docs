...
**Care Context:** A [Care Context](/docs/hiecm/v3/concepts/care-context) represents a patient's visit to a healthcare
...
subsequently made available in the patient's [PHR application](/docs/hiecm/v3/concepts/participants/phr).
...
registered details. When the patient selects the fetch option in the
[PHR application](/docs/hiecm/v3/concepts/participants/phr), the healthcare facility matches the respective demographic details
