...
source: NHA content review of 15 September 2026 (Sandbox2.0 M1, Scan and Register separated from M1); catalogue/openapi/hiecm/v3/hiecm-m2.yaml for the patient share calls
...
case sits beside [M1 Create](./m1): it uses the ABHA the person already holds.
...
The two calls: [receive a patient's shared profile](/docs/hiecm/v3/api/m2/endpoints/m2-callbacks/08-m2-post-v3-hip-patient-share) and [send the share acknowledgement](/docs/hiecm/v3/api/m2/endpoints/m2-abdm-patient-share-hip/01-m2-post-patient-share-v3-on-share). The patient's side is [P2 Linking and records](./p2#scan-and-share-at-a-facility).
