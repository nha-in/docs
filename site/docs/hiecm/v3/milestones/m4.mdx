---
title: 'M4 Registry Integration: Register facilities and professionals'
sidebar_label: M4 Registry Integration
sidebar_position: 7
...
- **Facilities going live.** A facility must be registered in the HFR and have
  ...
  an HIU. For facilities that have implemented [M2 (Attach)](./m2) or
  [M3 (Retrieve)](./m3), M4 is the next step towards production readiness.
...
The M4 skill gives an AI coding assistant this milestone as one file: every M4
call with its fields and identifiers. Install it, or open it in your assistant
in one click.

<SkillInstall slug="abdm-m4" note="Every M4 call in one file: 104 operations." />
...
- The patient side of all four: [P1 Registration and login](./p1).
