...
- **C, [M1](/docs/hiecm/v3/milestones/m1) Create.** Create and verify the patient's
  [ABHA](/docs/hiecm/v3/getting-started/glossary#abha), the identity every
  record hangs on.
- **A, [M2](/docs/hiecm/v3/milestones/m2) Attach.** Attach the records you hold to that identity: care
  contexts, linking, and sharing as a
  [HIP](/docs/hiecm/v3/getting-started/glossary#hip).
- **R, [M3](/docs/hiecm/v3/milestones/m3) Retrieve.** Retrieve records held elsewhere, with the
  patient's consent, as an [HIU](/docs/hiecm/v3/getting-started/glossary#hiu).
- **E, [M4](/docs/hiecm/v3/milestones/m4) Enrol.** Enrol your facility and your professionals in the
  registries, so you can go live.
