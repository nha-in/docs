...
A citizen fetching records is the
[HIU](/docs/hiecm/v3/getting-started/glossary#hiu), so every
[PHR](/docs/hiecm/v3/getting-started/glossary#phr) application must implement
that side.
