...
sidebar_label: P1 Registration and login
sidebar_position: 9
...
- Build all three creation paths: by mobile number, by an existing 14 digit
  ABHA number, and by Aadhaar number for someone with no ABHA number yet.
...
- The next milestone: [P2 Consents Management](./p2).
