...
lists the channels. The cases you are certified against are in the certification pack NHA issues.
...
reference](/docs/hiecm/v3/milestones/p1), written up as [creating an ABHA
