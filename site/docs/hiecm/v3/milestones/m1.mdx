...
The card is returned in the response rather than fetched from a separate link. The content type and encoding of the card and QR code responses are not documented yet; see the [APIs](/docs/hiecm/v3/api/m1/apis) page for what is.
