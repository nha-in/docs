...
[NHA](/docs/abdm/v3/glossary#nha) groups integration work on the
[HIE-CM](/docs/abdm/v3/glossary#hie-cm) gateway into four milestones, M1 to M4, each with its
...
| --- | --- |
| [M1](/docs/abdm/v3/api/m1) | Identity. You can create an [ABHA](/docs/abdm/v3/glossary#abha), log a user in, read and manage the profile, and hold the session token every other call needs. |
| [M2](/docs/abdm/v3/api/m2) | Linking and sharing. You can group records into care contexts, link them to an ABHA address, answer discovery, package data as [FHIR](/docs/abdm/v3/glossary#fhir) and send it encrypted. |
| [M3](/docs/abdm/v3/api/m3) | Consent and fetching. You can raise a consent request, follow it to granted or denied, then fetch and decrypt the health information. |
| [M4](/docs/abdm/v3/api/m4) | Provider registries. You can register a professional in the [HPR](/docs/abdm/v3/glossary#hpr) and a facility in the [HFR](/docs/abdm/v3/glossary#hfr), and link your software to that facility. |
...
A [PHR](/docs/abdm/v3/glossary#phr) application serves the patient, an
[HIP](/docs/abdm/v3/glossary#hip) holds records it created, an
[HIU](/docs/abdm/v3/glossary#hiu) reads records held elsewhere, and most hospital systems are
both HIP and HIU. See [HIP and HIU](/docs/abdm/v3/concepts/hip-hiu).
...
[Sandbox access](/docs/abdm/v3/sandbox) has the credentials they all need.
