...
What you build on [ABDM](/docs/abdm/v3/glossary#abdm) depends on whether your system creates
...
| --- | --- | --- |
| PHR app | [PHR](/docs/abdm/v3/glossary#phr) and [HIU](/docs/abdm/v3/glossary#hiu) | M1, M3, plus the patient side of M2 |
| Hospital or clinic system | [HIP](/docs/abdm/v3/glossary#hip), often HIU too | M1, M2 and M4 before go live. Add M3 to read records from elsewhere |
...
That is [M4](/docs/abdm/v3/api/m4) work. A PHR app is the exception: it is not a facility.
[Integration milestones](/docs/abdm/v3/milestones) has the full table.

## A PHR app

A patient holds their [ABHA](/docs/abdm/v3/glossary#abha) address here and reads their own
records. [NHA](/docs/abdm/v3/glossary#nha)'s PHR document lists the functions such an app has
to provide:
...
- Discover records at a facility the user names, then link those care contexts after an OTP
  check ([OTP](/docs/abdm/v3/glossary#otp)).
...
[HIU](/docs/abdm/v3/glossary#hiu) functionality, which is Milestone 3. Start at
[PHR applications](/docs/abdm/v3/phr).

## A hospital or clinic system

Your system creates records, so it takes the [HIP](/docs/abdm/v3/glossary#hip) role. NHA's
...
[FHIR](/docs/abdm/v3/glossary#fhir) bundles when a valid consent arrives. Milestone 2 lists
eight health record types, and implementing all of them is mandatory for an
[HMIS](/docs/abdm/v3/glossary#hmis). Most hospital systems take the HIU role too, which is
Milestone 3. Start at
[Hospital, lab and pharmacy systems](/docs/abdm/v3/concepts/hip-hiu).
...
and the invoice record for billing. See [M2](/docs/abdm/v3/api/m2).
...
exchange itself runs on a different gateway, [NHCX](/docs/abdm/v3/glossary#nhcx). See
[M3](/docs/abdm/v3/api/m3) and [NHCX](/docs/nhcx/v1).
