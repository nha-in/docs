...
[ABDM](/docs/abdm/v3/glossary#abdm) API, so nothing here is an endpoint you can
call.
...
| --- | --- |
| [ABDM](/docs/abdm/v3/glossary#abdm), NDHM | The programme. NDHM is the former name and both appear in the source. |
| [PHR](/docs/abdm/v3/glossary#phr) | Personal health record application. |
| [HIU](/docs/abdm/v3/glossary#hiu) | Health information user. |
| [UHI](/docs/abdm/v3/glossary#uhi) | Unified Health Interface. |
| [NHCX](/docs/abdm/v3/glossary#nhcx) | National Health Claims Exchange. |
| [HMIS](/docs/abdm/v3/glossary#hmis) | Hospital management information system. |
| [OTP](/docs/abdm/v3/glossary#otp) | One time password. |
...
This dictionary describes NHA's portal, not the [ABDM](/docs/abdm/v3/glossary#abdm)
APIs. It carries no request shape, no response shape and no endpoint. Registry
identifiers such as [ABHA](/docs/abdm/v3/glossary#abha) numbers do not appear in
it at all.

For the APIs, start at [choose your gateway](/docs/abdm/v3). For the sandbox
itself and how to sign up, read [get started](/docs/abdm/v3/sandbox).
