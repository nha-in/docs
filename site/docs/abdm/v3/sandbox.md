...
Four steps stand between you and your first [ABDM](/docs/abdm/v3/glossary#abdm) call: register
...
[NHA](/docs/abdm/v3/glossary#nha) reviews the request before it issues them. Its documents give
...
- Decide which role your system takes. [What you can build](/docs/abdm/v3/what-you-can-build)
  maps a kind of system to the milestones it needs, and
  [Integration milestones](/docs/abdm/v3/milestones) gives the role to milestone table.
- Read the [M1 API sequence](/docs/abdm/v3/api/m1/sequence) for the order of calls.
...
not transcribed here. See [M1 APIs](/docs/abdm/v3/api/m1/apis) for what the Postman collection
does carry.

## 4. Make a first call

The smallest useful call starts [ABHA](/docs/abdm/v3/glossary#abha) creation by sending a
one-time password ([OTP](/docs/abdm/v3/glossary#otp)) to the mobile number linked to the
...
transcribed. See [M1 APIs](/docs/abdm/v3/api/m1/apis) for what the Postman collection does
carry, and [M1 API sequence](/docs/abdm/v3/api/m1/sequence) for the order of calls.

## Where to go next

- [What you can build](/docs/abdm/v3/what-you-can-build) to pick your milestones.
- [Introduction](/docs/abdm/v3) for what [HIE-CM](/docs/abdm/v3/glossary#hie-cm) covers.
