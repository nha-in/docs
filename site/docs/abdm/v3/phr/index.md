...
A [PHR](/docs/abdm/v3/glossary#phr) application is the patient's app in
[ABDM](/docs/abdm/v3/glossary#abdm): it holds a person's
[ABHA](/docs/abdm/v3/glossary#abha) address, finds their records, takes consent and
shows the records back. You build [M1](/docs/abdm/v3/api/m1) for identity,
[M3](/docs/abdm/v3/api/m3) for consent and record fetching, and some
[M2](/docs/abdm/v3/api/m2) if users upload their own records.
...
| Find and link past records | Search a facility, discover [care contexts](/docs/abdm/v3/glossary#care-context), verify by [OTP](/docs/abdm/v3/glossary#otp), link |
...
| --- | --- | --- | --- |
| Mobile number | Mobile OTP | The user types them | **Self-Declared**, no [KYC](/docs/abdm/v3/glossary#kyc) |
...
[HIP](/docs/abdm/v3/glossary#hip) ID and a facility defined context such as a
...
3. Calls the [HIE-CM](/docs/abdm/v3/glossary#hie-cm) API to share the details.
...
be the [HFR](/docs/abdm/v3/glossary#hfr) facility ID, the
[HPID](/docs/abdm/v3/glossary#hpid), the HIP ID or the HIP name.
...
[HIU](/docs/abdm/v3/glossary#hiu) role.
...
4. It raises a health information request with the approved
   [consent artefact](/docs/abdm/v3/glossary#consent-artefact).
...
[HRP](/docs/abdm/v3/glossary#hrp). Your app sends a discovery request to the
...
linking from [M2](/docs/abdm/v3/api/m2), and the M2 health information transfer
APIs.

## What you do not need to build

- **Facility side clinical records.** No [FHIR](/docs/abdm/v3/glossary#fhir)
  bundles from a hospital or lab system, other than records your users upload.
- **[HPR](/docs/abdm/v3/glossary#hpr) and HFR registration.** M4 covers the
  professional and facility registries.
- **[UHI](/docs/abdm/v3/glossary#uhi).** Consultation, ambulance and pharmacy
  booking runs on a separate gateway.
- **[NHCX](/docs/abdm/v3/glossary#nhcx).** Claims and insurance exchange runs on a
  separate gateway.

## What to read next

- [M1 overview](/docs/abdm/v3/api/m1) for ABHA creation, login and session APIs,
  and the [M1 API reference](/reference/hiecm-m1).
- [M3 overview](/docs/abdm/v3/api/m3) for consent, subscriptions and data fetch,
  and the [M3 API reference](/reference/hiecm-m3).
- [M2 overview](/docs/abdm/v3/api/m2) if you are building a health locker, and the
  [M2 API reference](/reference/hiecm-m2).
- [Get started](/docs/abdm/v3/sandbox) for sandbox signup and your first call.
- [Hospital, lab and pharmacy systems](/docs/abdm/v3/concepts/hip-hiu) for the
