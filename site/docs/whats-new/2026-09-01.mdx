...
[consent](/docs/hiecm/v3/getting-started/glossary#consent-artefact) story as the M3 specification
...
order the exit process runs in, including the Safe to Host audit by a CERT-In
empanelled auditor, and names what is not yet published
