...
sidebar_label: 24 August 2026
sidebar_position: 4
hide_title: true
description: What changed in these pages on 24 August 2026.
...
<ReleaseGroup date="2026-08-24" as="h1">
...
These pages follow the sandbox document pack.
Nothing in them has been run against the ABDM sandbox, so every page carries
`verification: unverified`. Where a request or response shape is not yet
published, the page says so instead
...
[NHCX](/docs/nhcx/v1). Those pages tell you what is published and where to read
it.
