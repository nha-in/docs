...
[UHI](/docs/abdm/v3/glossary#uhi) is the Unified Health Interface, one of [ABDM](/docs/abdm/v3/glossary#abdm)'s three gateways. After this page you will know the two roles, the two transports and the signing scheme that every UHI service shares.

[HIE-CM](/docs/abdm/v3/glossary#hie-cm) moves records that already exist. UHI helps a patient find and book a service before any record exists: a consultation, an ambulance, a unit of blood, a medicine at a pharmacy. Any consumer app on the network can discover any provider on it.

## Prerequisite

Your application must have completed ABDM [M2](/docs/abdm/v3/api/m2) with HIE-CM before it can be onboarded to any UHI service. NHA states this as a hard requirement. UHI sits on top of HIE-CM, it is not an alternative to it.

## Two roles

| Role | Full name | What it is |
| --- | --- | --- |
| [EUA](/docs/abdm/v3/glossary#eua) | End User Application | The patient facing app or website. Searches, shows results, books, displays status. |
| [HSPA](/docs/abdm/v3/glossary#hspa) | Health Service Provider Application | The provider platform. Holds doctor profiles and slot availability, confirms bookings, drives the appointment lifecycle. |

The HSP is the hospital, clinic or doctor, and the HSPA is its digital interface. The Gateway is NHA's routing layer, and [NHA](/docs/abdm/v3/glossary#nha) is the network operator that governs onboarding and the protocol.
...
- [Physical consultation](/docs/uhi/v1/services/physical-consultation)
- [Ambulance booking](/docs/uhi/v1/services/ambulance-booking)
- [Blood bank](/docs/uhi/v1/services/blood-bank)
...
- [AMRIT pharmacy](/docs/uhi/v1/services/amrit-pharmacy)
...
Our source is NHA's physical consultation onboarding document, version 2.0. Its per stage request and response bodies sit on the [physical consultation](/docs/uhi/v1/services/physical-consultation) page. The other six services have their own documents and are not covered here.

## Next

- [HIE-CM gateway](/docs/abdm/v3/building-blocks/hie-cm)
- [What you can build, by role](/docs/abdm/v3/what-you-can-build)
