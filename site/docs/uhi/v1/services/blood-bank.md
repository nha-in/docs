...
Blood bank discovery is the smallest service on [UHI](/docs/abdm/v3/glossary#uhi): one call pair. Your app sends a search with a blood group, a component and a location, and gets back blood banks with unit counts, addresses and phone numbers.
...
| Role | What it does |
| --- | --- |
| [EUA](/docs/abdm/v3/glossary#eua) | A patient or clinician facing app. Sends searches, receives results at its callback URL |
| [HSPA](/docs/abdm/v3/glossary#hspa) | A blood bank management system or aggregator. Answers searches from its own inventory database |
...
[NHA](/docs/abdm/v3/glossary#nha) sets a bar for the HSPA role. Your blood bank database has to be maintained independently and cover stock at a scope and quality comparable to e-RaktKosh. Integrations built on manually maintained or infrequently updated records will not be approved for production.
...
| 2 | [Gateway](/docs/abdm/v3/glossary#gateway) | Returns HTTP 200 with an acknowledgement. This confirms receipt only |
...
- [ABDM](/docs/abdm/v3/glossary#abdm) [M2](/docs/abdm/v3/api/m2) with [HIE-CM](/docs/abdm/v3/glossary#hie-cm) completed. NHA states this as a hard prerequisite for any UHI service.
