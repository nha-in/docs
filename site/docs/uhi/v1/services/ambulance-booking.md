...
Ambulance booking on [UHI](/docs/abdm/v3/glossary#uhi) lets a patient or a caregiver find ambulances near them across every registered provider, see arrival windows and indicative charges, and start a booking with the one they pick. After this page you will know the four calls that are live today, their fields, and what [NHA](/docs/abdm/v3/glossary#nha) tests your app for.
...
| --- | --- |
| [EUA](/docs/abdm/v3/glossary#eua) | The patient or caregiver app. Sends the search, shows options, sends `init`, shows the quote and terms |
| [HSPA](/docs/abdm/v3/glossary#hspa) | The ambulance operator's platform. Answers searches with live availability, answers `init` with a quote |
| [Gateway](/docs/abdm/v3/glossary#gateway) | NHA's routing layer. Broadcasts the search. Not involved from `init` onwards |
...
| `order.customer.id` | string | Mandatory | Patient [ABHA](/docs/abdm/v3/glossary#abha) address, for example `91XXXXXXXXXX@sbx` |
...
- [ABDM](/docs/abdm/v3/glossary#abdm) [M2](/docs/abdm/v3/api/m2) with [HIE-CM](/docs/abdm/v3/glossary#hie-cm) completed. This is the hard prerequisite for production access.
...
- [Physical consultation](/docs/uhi/v1/services/physical-consultation), the service with the full lifecycle
