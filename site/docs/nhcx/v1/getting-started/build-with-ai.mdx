...
description: "Give your coding agent the NHCX documentation and skills: over the Docs MCP server, as agent skills, or as Markdown it fetches."
verification: unverified
source: nhcx-package, system/build-ekadocs.mjs
generated: true
---
