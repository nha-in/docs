...
description: Assembling the protected header, sealing a FHIR bundle for the recipient, and posting it to the exchange.
verification: unverified
source: Message Security and Integrity page; NHCX Code Snippets references for payload preparation; NHCX Integration Handbook §2; API Response Handling to avoid Failures; AWS Sandbox NHCX USECASE Postman collection
sidebar_position: 7
---
