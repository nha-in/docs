...
description: Every workflow code with the status word it expects, by stage, with the lifecycle diagrams and the places sources disagree.
verification: unverified
source: "Workflow Status Sheets with Codes (18 Aug 2026); NHCX Requests and Responses for UseCases, value sets; NHCX Integration Handbook §4; Common Mistakes while implementing through NHCX #1"
sidebar_position: 2
---
