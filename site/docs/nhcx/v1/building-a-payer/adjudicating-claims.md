...
description: The claim queue against the approved preauthorisation, the denial codes, appeals, and answering a regulator's search.
verification: unverified
source: NHCX Integration Handbook §9, §10; Claim (NHA); NHCX-PMJAY-HMIS Integration Guide §4, §8.5; NHCX FAQs v1.2 §22, §23; Standard Error Codes, Claim; NHCX Requests and Responses, Reprocess and Search sheets, denial codes; access-control page
sidebar_position: 5
---
...
- The claim is opened against the approved preauthorisation, with the difference highlighted.
- Two interim states are not decisions: in process, and forwarded.
- A rejection closes the claim number. Nothing further arrives against it except a Task.
- Appeals arrive as a Task on workflow 36 and are answered with a `ClaimResponse` inside it.
