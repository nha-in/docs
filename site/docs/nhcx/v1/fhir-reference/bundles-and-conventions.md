...
description: "The rules every NHCX FHIR bundle obeys before any use case: the collection bundle, profiles, references, ids and attachments."
verification: unverified
source: Domain Specifications page; Implementation Guide for Adoption of FHIR in ABDM and NHCX; NHCX Integration Handbook §1.3, Appendix A.3; NHCX-PMJAY-HMIS Integration Guide §7.4, §8.4.0; Sample FHIR bundles
sidebar_position: 1
---
