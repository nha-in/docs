---
title: Sample bundles
sidebar_label: Sample bundles
description: "The twenty-two real payloads every chapter here is built on: where they are, what each is, and the eight gaps they leave."
verification: unverified
source: Sample FHIR bundles, PMJAY extract, 22 files; AWS Sandbox NHCX use case Postman collection; NHCX PMJAY Integration Handbook; NHCX FAQs; NHCX portal mirror fetched 1 September 2026
sidebar_position: 20
---
