---
title: Preauthorisation enhancement
sidebar_label: Preauthorisation enhancement
description: An enhancement is a preauthorisation bundle with one more item. Nothing in the payload says which it is.
verification: unverified
source: "Sample FHIR bundles, `preauth/enhancement/enhancement_req.txt`, `preauth/enhancement/enhancement_resp.txt`, `preauth/preauth_request.txt`; NHCX-PMJAY-HMIS Integration Guide §8.4.3; NHCX APIs to be called based on scenario, row 7; NHCX PMJAY Integration Handbook §8.5, workflow table"
sidebar_position: 10
---
