...
sidebar_label: "Plan: package-based (scheme)"
description: "The scheme shape, and the only one with a real payload: two parallel structures, 32 categories, sixteen flags per package."
verification: unverified
source: "NHCX Integration Handbook §6; Insurance Plan Implementation Guide; NHCX-PMJAY-HMIS Integration Guide §8.1; NHCX FAQs v1.2 #15; Sample FHIR bundles, `insuranceplan/insuranceplan_response.txt`"
sidebar_position: 6
---
