...
description: "The only exchange carrying real money: three notices as the transfer moves, the UTR, and the acknowledgement Task."
verification: unverified
source: "Sample FHIR bundles, `paymentNotice/payment_notice.txt` and `paymentNotice_ack.txt`, `claim/claim_queryUpdate_response.txt`; NHCX PMJAY Integration Handbook §4.1, §4.2, §11; NHCX Requests and Responses for UseCases, Value sets and PaymentNotice sheets; Payment (NHA); NHCX Provider Side Use Cases, Sandbox Exit Process"
sidebar_position: 16
---
