...
sidebar_position: 8
description: What the Ayushman Bharat scheme changes on the network, and the scheme rules a hospital system must follow.
...
[Scheme rules the HMIS must implement](/docs/nhcx/v1/concepts/pmjay-use-cases#scheme-rules-the-hmis-must-implement), in PMJAY use cases, gives the codes, fields, tariffs and error codes behind each rule.
