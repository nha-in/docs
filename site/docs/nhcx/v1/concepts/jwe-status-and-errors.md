...
description: The envelope and the sealed letter, every header field, the status words, receipts, and what to send when the sources disagree.
verification: unverified
source: NHCX sandbox portal, Technical Specifications, Message Security and API Security pages; API Response Handling to avoid Failures; Common Mistakes while implementing through NHCX; Standard Error Codes (Aug 2026); Workflow Status Sheets (Aug 2026); NHCX Integration Handbook v1.0; NHCX FAQs v1.2
sidebar_position: 5
---
