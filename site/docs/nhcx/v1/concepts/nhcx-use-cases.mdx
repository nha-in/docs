...
sidebar_position: 5
description: Catalog of all 38 NHA use cases across A, B, C, D, E series
...
- **FHIR Reference:** [Status and Search, A5](/docs/nhcx/v1/reference/fhir/status-and-search#a5-get-status-shared)
...
- **FHIR Reference:** [Status and Search, B6](/docs/nhcx/v1/reference/fhir/status-and-search#b6-search-claims-provider)
...
- **FHIR Reference:** [Status and Search, C8](/docs/nhcx/v1/reference/fhir/status-and-search#c8-respond-to-search-payer)
