...
description: The ten steps of a health insurance claim, the parties to it, and the email-and-portal mechanism NHCX replaces.
verification: unverified
source: NHCX Documentation v1.5.0; NHCX Guide for Providers (NHA)
sidebar_position: 3
---
