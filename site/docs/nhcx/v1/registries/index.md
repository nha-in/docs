...
sidebar_position: 3
description: "The two registries every NHCX call depends on: participants, and the policies linked to a beneficiary."
...
- [Participant registry](/docs/nhcx/v1/registries/participant): how a participant joins the network, registers its key and callback address, authenticates, and finds other participants.
- [Policy registry](/docs/nhcx/v1/registries/policy): how a beneficiary's policy is found, which participant code to address, and how a payer links a policy to ABHA.
