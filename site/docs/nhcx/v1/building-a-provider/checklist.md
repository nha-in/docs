---
title: Provider sandbox checklist
sidebar_label: Provider checklist
description: The thirteen use cases a provider demonstrates to leave the sandbox, what to test first, and where the first week goes wrong.
verification: unverified
source: NHCX Provider Side Use Cases, Sandbox Exit Process; NHCX-PMJAY-HMIS Test Cases; Common Mistakes while implementing through NHCX; NHCX Dummy Payer Implementation; NHCX Guide for Providers; PMJAY Hospital Migration to HMIS via NHCX
sidebar_position: 9
---
