...
description: Who to write to about NHCX integration, certification, FHIR bundles and credentials, and what to include so the call can be traced.
source: site/docs/nhcx/v1/getting-started/get-your-sandbox-credentials.md and reference/troubleshooting.md
---
...
- [Troubleshooting](/docs/nhcx/v1/troubleshooting): what to do when something breaks, by symptom.
- [Troubleshooting by layer and code](/docs/nhcx/v1/reference/troubleshooting): every layer of a call, and what each error code means there.
- [Error codes](/docs/nhcx/v1/reference/error-codes): every code with its message.
