...
| [Update ABHA number](/docs/nhcx/v1/api/adjudicator/endpoints/adjudicator-update-abhanumber) | Any participant | Sandbox and production | `POST https://apisbx.abdm.gov.in/pmjay/sbxhcx/participanthcxservice/update/abhanumber` | Replaces a placeholder (dummy) ABHA number with the beneficiary's real ABHA number. |
