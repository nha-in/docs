...
P3 is the other side of [M3 Health Information User](/docs/pr-22/docs/hiecm/v3/milestones/m3). M3 is a requester asking for records. P3 is the patient deciding, and being told each time.

A citizen fetching records is the [HIU](/docs/pr-22/docs/hiecm/v3/getting-started/glossary#hiu), so every [PHR](/docs/pr-22/docs/hiecm/v3/getting-started/glossary#phr) application must implement that side.
...
2. Set up an auto approval policy with the [HIE-CM](/docs/pr-22/docs/hiecm/v3/getting-started/glossary#hie-cm).
...
5. The [HIP](/docs/pr-22/docs/hiecm/v3/getting-started/glossary#hip) sends the records across the network.
6. Your app stores them for long term access and displays them, preferably in chronological order.

## Next

- The calls and base URLs: [P3 API reference](/docs/pr-22/reference/hiecm-p3).
- Back to the four provider milestones: [Milestones](/docs/pr-22/docs/hiecm/v3/milestones).
