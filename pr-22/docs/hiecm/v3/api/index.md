...
[Read the whole specification](/docs/pr-22/reference/hiecm-gateway)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-m1)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-m2)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-m3)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-m4)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-p1)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-p2)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-p3)

## P4 Locker

4 endpoints across 1 use case: Locker. Each endpoint has its own page in the sidebar.

[Read the whole specification](/docs/pr-22/reference/hiecm-p4)
...
[Read the whole specification](/docs/pr-22/reference/hiecm-scan-and-pay)
