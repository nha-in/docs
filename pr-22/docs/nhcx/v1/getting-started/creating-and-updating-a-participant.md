...
[Participant create (v1) in the API reference](/docs/pr-22/docs/nhcx/v1/api/onboarding/endpoints/onboarding-participant-create)
...
[Participant update (v1) in the API reference](/docs/pr-22/docs/nhcx/v1/api/registry/endpoints/registry-participant-update)
...
[Participant create (v2) in the API reference](/docs/pr-22/docs/nhcx/v1/api/onboarding/endpoints/onboarding-v2-participant-create)
...
[Validate participant creation in the API reference](/docs/pr-22/docs/nhcx/v1/api/onboarding/endpoints/onboarding-validate)
...
[Participant certificate and bridge update (v2) in the API reference](/docs/pr-22/docs/nhcx/v1/api/registry/endpoints/registry-v2-participant-update)
...
[Validate participant update in the API reference](/docs/pr-22/docs/nhcx/v1/api/onboarding/endpoints/onboarding-update-validate)
...
[Update certificate (v2, no passcode) in the API reference](/docs/pr-22/docs/nhcx/v1/api/registry/endpoints/registry-v2-update-cert)
