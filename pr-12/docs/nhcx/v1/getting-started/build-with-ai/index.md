...
- Each NHCX API module has its own index at `/docs/nhcx/v1/api/<module>/llms.txt`. [API references](/docs/pr-12/docs/nhcx/v1/api) names the modules.
...
| Skill                | What it builds                                                                              | [Use cases](/docs/pr-12/docs/nhcx/v1/concepts/nhcx-use-cases) |
| -------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
...
- [Coverage](https://nha-in.github.io/docs/pr-12/skills/nhcx-coverage/SKILL.md)
- [Insurance plan](https://nha-in.github.io/docs/pr-12/skills/nhcx-insurance/SKILL.md)
- [Pre-authorisation](https://nha-in.github.io/docs/pr-12/skills/nhcx-preauth/SKILL.md)
- [Claim](https://nha-in.github.io/docs/pr-12/skills/nhcx-claim/SKILL.md)
- [Payment](https://nha-in.github.io/docs/pr-12/skills/nhcx-payment/SKILL.md)
- [Communication](https://nha-in.github.io/docs/pr-12/skills/nhcx-communication/SKILL.md)
- [Reprocess and status](https://nha-in.github.io/docs/pr-12/skills/nhcx-reprocess/SKILL.md)

In Claude Code the portal's `nhcx` plugin carries all seven. Add the portal's marketplace as [Install the plugin](/docs/pr-12/docs/hiecm/v3/getting-started/build-with-ai#install-the-plugin) shows, then run `claude plugin install nhcx@abdm-portal`.

## Next steps

- [Get your sandbox credentials](/docs/pr-12/docs/nhcx/v1/getting-started/get-your-sandbox-credentials)
- [Quickstart](/docs/pr-12/docs/nhcx/v1/getting-started/quickstart)
- [The base framework](/docs/pr-12/docs/nhcx/v1/getting-started/the-base-framework)
