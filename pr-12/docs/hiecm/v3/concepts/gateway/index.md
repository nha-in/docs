...
The gateway is the routing layer for [ABDM](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#abdm). You never call a hospital, a lab or a [PHR](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#phr) app directly. The answer to a call arrives later at an endpoint you expose, and the gateway issues the access token every other call carries.

## Gateway and HIE-CM are not the same thing

[HIE-CM](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hie-cm) is the service: patient identity, care context links and consent. Its four modules and who builds which are on [Integration milestones](/docs/pr-12/docs/hiecm/v3/milestones).
...
- **You get an acknowledgement, not an answer.** In the [M3](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#m3) consent flow the [HIU](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hiu) asks, the HIE-CM acknowledges with a consent request id, and the patient's decision comes back later. Each call's page in the [API reference](/docs/pr-12/docs/hiecm/v3/api) names the callback it produces.
- **You have to be reachable.** Half of [M2](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#m2) is endpoints the gateway calls on your system. A [HIP](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hip) it cannot reach fails on someone else's logs, as `ABDM-1028 HIP is unavailable`.
...
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| [M1](/docs/pr-12/docs/hiecm/v3/api/m1) | Session tokens, and the calls that create and authenticate an ABHA identity                                                                                           | [M1 API reference](/docs/pr-12/reference/hiecm-m1) |
| [M2](/docs/pr-12/docs/hiecm/v3/api/m2) | [Discovery](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#discovery), care context linking, health information requests to a HIP                                 | [M2 API reference](/docs/pr-12/reference/hiecm-m2) |
| [M3](/docs/pr-12/docs/hiecm/v3/api/m3) | Consent requests, consent notifications, artefact fetches, data flow requests                                                                                         | [M3 API reference](/docs/pr-12/reference/hiecm-m3) |
| [M4](/docs/pr-12/docs/hiecm/v3/api/m4) | Session tokens for the [HPR](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hpr) and [HFR](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hfr) registry calls | [M4 API reference](/docs/pr-12/reference/hiecm-m4) |

The gateway holds no health record. It routes the permission and the metadata.

## The session endpoint

One endpoint issues the token every other call carries. It is the same call in [M1](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#m1) and [M4](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#m4).
...
Send the token back as `Authorization: Bearer <ACCESS_TOKEN_FROM_SESSIONS_CALL>` on every other call. Headers per call, and the second token M1 login issues, are on [authentication](/docs/pr-12/docs/hiecm/v3/reference/authentication). Interactive: [gateway API reference](/docs/pr-12/reference/hiecm-gateway).
...
- **Request signing.** The gateway request itself is not signed. Payload encryption and signing apply to health records, on the [M2](/docs/pr-12/docs/hiecm/v3/api/m2) side.

## Next

- [Authentication](/docs/pr-12/docs/hiecm/v3/reference/authentication), credentials and headers.
- [API references](/docs/pr-12/docs/hiecm/v3/api), every call and the callback it produces.
- [Integration milestones](/docs/pr-12/docs/hiecm/v3/milestones), the four modules and who builds which.
- [Registries](/docs/pr-12/docs/hiecm/v3/registries), who and what ABDM identifies.
- [Error codes](/docs/pr-12/docs/hiecm/v3/reference/error-codes), what a rejection means.
