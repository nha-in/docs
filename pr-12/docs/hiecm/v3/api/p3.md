...
P3 is the other side of [M3](/docs/pr-12/docs/hiecm/v3/api/m3). M3 is a requester asking for records; P3 is the patient deciding.
...
The full operation list is in the [P3 PHR consent and notifications API reference](/docs/pr-12/reference/hiecm-p3).
