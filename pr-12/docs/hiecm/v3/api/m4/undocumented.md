...
Every Milestone 4 call for the [HPR](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hpr) and the [HFR](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hfr), with its parameters, its codes and the rules that apply to it. Two operations carry a published path and have their own pages under APIs. The rest are here.
...
The first call you make. Same session pattern as [M1](/docs/pr-12/docs/hiecm/v3/api/m1), issued by the [HIE-CM](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hie-cm) gateway.
...
Both hosts are listed under [Base URLs](/docs/pr-12/docs/hiecm/v3/api/m4#base-urls).
...
Three fields below are sent encrypted: the mobile number in mobile match, the [OTP](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#otp) in the HPR mobile login, and the email and password in create HPID. All use the same public certificate, so fetch it once.
...
| 4    | Check HPID exists by Aadhaar        | Returns the [HPID](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#hpid) already registered for this Aadhaar, if there is one                    | Behaviour only    |
...
| `hipName`      | Yes      | The name a patient sees in their [ABHA](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#abha) or [PHR](/docs/pr-12/docs/hiecm/v3/getting-started/glossary#phr) app. 15 characters or fewer, no special characters, unique for every bridge on a facility |
| `type`         | Yes      | `HIP` or `HIU`                                                                                                                                                                                                                                              |
...
- The interactive reference: [M4 API reference](/docs/pr-12/reference/hiecm-m4).
- The order of calls, as diagrams: [M4 user journeys](/docs/pr-12/docs/hiecm/v3/milestones/m4).
- A path missing here that you need now: ask on [support](/docs/pr-12/docs/support).
