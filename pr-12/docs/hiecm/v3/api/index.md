...
[Read the whole specification](/docs/pr-12/reference/hiecm-gateway)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-m1)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-m2)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-m3)

## M4 HPR and HFR

2 endpoints across 2 use cases: HPR login, HFR master data. Each endpoint has its own page in the sidebar.

[Read the whole specification](/docs/pr-12/reference/hiecm-m4)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-p1)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-p2)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-p3)
...
[Read the whole specification](/docs/pr-12/reference/hiecm-phr-services)
...
| ----------------------- | ------ | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| M2 Linking and sharing  | POST   | [`/api-hiu/data/notification`](/docs/pr-12/docs/hiecm/v3/api/m2/endpoints/m2-on-data-notification)                  | The provider pushes encrypted health information to the URL named in the request. |
| M3 Consent and fetching | POST   | [`/api/v3/consent/request/hip/notify`](/docs/pr-12/docs/hiecm/v3/api/m3/endpoints/m3-on-consent-request-notify-hip) | The patient's decision, sent to the record holder                                 |
| M3 Consent and fetching | POST   | [`/health-information/transfer`](/docs/pr-12/docs/hiecm/v3/api/m3/endpoints/m3-on-health-information-transfer)      | The encrypted health data itself, pushed to the URL you supplied                  |
