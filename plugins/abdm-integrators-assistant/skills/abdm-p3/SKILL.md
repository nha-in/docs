...
This file is a snapshot. Re-download the whole folder from the portal's /skills/abdm-p3/ path when it is older than the work you are doing: this router and every file under references/ that it links to. Fetching this file alone leaves those links pointing at files you do not have.
