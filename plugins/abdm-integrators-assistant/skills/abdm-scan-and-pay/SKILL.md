...
This file is a snapshot. Re-download it from the portal's /skills/abdm-scan-and-pay/SKILL.md path when it is older than the work you are doing.
...
- **Integrate.** 64 operations, with their hosts and headers. [references/integrate.md](references/integrate.md)
