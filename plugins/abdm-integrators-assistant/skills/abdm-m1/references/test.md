...
| `CRT_ABHA_112` | Mandatory | Suggested ABHA Address |  | System should prompt / display the available or suggested ABHA addresses. System should allow the user to pro… |
...
| `CRT_ABHA_114` | Mandatory | View and Download ABHA details. (If integrators is generating ABHA card) |  | User should be able to view their ABHA Card with all the demographc details as mentioned in cell H26 |
| `CRT_ABHA_115` | Optional | View and Download ABHA details. (If integrators is not generating ABHA card) |  | User should be able to view card with ABHA number and ABHA address and the details should be saved in HIMS sy… |
...
| `CRT_ABHA_209` | Mandatory | View and Download ABHA details. (If integrators is generating ABHA card) |  | User should be able to view their ABHA Card |
| `CRT_ABHA_210` | Optional | View and Download ABHA details. (If integrators is not generating ABHA card) |  | User should be able to view card with ABHA number and ABHA address and the details should be saved in HIMS sy… |
...
| `CRT_ABHA_308` | Mandatory | View and Download ABHA details. (If integrators is generating ABHA card) |  | User should be able to view their ABHA Card |
| `CRT_ABHA_309` | Optional | View and Download ABHA details. (If integrators is not generating ABHA card) |  | User should be able to view card with ABHA number and ABHA address.and the details should be saved in HIMS sy… |
