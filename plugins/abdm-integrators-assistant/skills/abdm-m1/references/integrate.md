...
163 operations, grouped by the journey they belong to.
...
| `GET` | `/abha/api/v3/enrollment/profile/children` | UseCase: Get Child ABHA address |
| `POST` | `/abha/api/v3/enrollment/request/otp` | Use Case: ABHA enrollment - Send OTP using Aadhaar number Mobile number, ABHA n… |
| `POST` | `/abha/api/v3/enrollment/request/otp` | Use Case: ABHA enrollment - Send OTP using Aadhaar number Mobile number, ABHA n… |
| `POST` | `/abha/api/v3/enrollment/request/otp` | Use Case: ABHA enrollment - Send OTP using Aadhaar number Mobile number, ABHA n… |
| `POST` | `/abha/api/v3/enrollment/request/otp` | Use Case: ABHA enrollment - Send OTP using Aadhaar number Mobile number, ABHA n… |
| `POST` | `/abha/api/v3/enrollment/request/otp` | Use Case: ABHA enrollment - Send OTP using Aadhaar number Mobile number, ABHA n… |
