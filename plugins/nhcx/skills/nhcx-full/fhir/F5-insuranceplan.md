...
- FHIR: [F1. Bundle](F1-bundle.md), [F3. CoverageEligibilityResponse](F3-coverage-eligibility-response.md), [F4. Task (InsurancePlan discovery)](F4-task-insuranceplan.md), [F6. Questionnaire](F6-questionnaire.md)
