...
| Exchange | NHA | Our API | Send route | Bundle sent | Workflow id | Reply route | Bundle back | Callback |
|---|---|---|---|---|---|---|---|---|
| Pre-authorisation | nha:B3, nha:D4 | A4 (in nhcx-preauth) | `v1/preauth/submit` | F8 (in nhcx-preauth) (`use: preauthorization`) with F7 (in nhcx-preauth), [F15](../fhir/F15-patient.md) to [F19](../fhir/F19-other-resources.md) | 12 | `v1/preauth/on_submit` | F9 (in nhcx-preauth) | C5 (in nhcx-preauth) |
...
| Cancel the pre-authorisation | nha:D8 | A6 (in nhcx-preauth) (cancel) | `v1/task/submit` | F10 (in nhcx-preauth) (Task `cancel`) | PC01 | `v1/task/on_submit` | F10 (in nhcx-preauth) pointing at F9 (in nhcx-preauth) | C7 (in nhcx-preauth) |
...
| Exchange | NHA | Our API | Send route | Bundle sent | Workflow id | Reply route | Bundle back | Callback |
|---|---|---|---|---|---|---|---|---|
| Claim | nha:B5, nha:D9 | A5 (in nhcx-claim) | `v1/claim/submit` | F8 (in nhcx-preauth) (`use: claim`) with F7 (in nhcx-preauth), [F15](../fhir/F15-patient.md) to [F19](../fhir/F19-other-resources.md) | 15 | `v1/claim/on_submit` | F9 (in nhcx-preauth) | C6 (in nhcx-claim) |
...
| Reprocess a decided claim | nha:D11 | A6 (in nhcx-preauth) (reprocess) | `v1/task/submit` | F10 (in nhcx-preauth) (Task) | 36 | `v1/task/on_submit` | F10 (in nhcx-preauth) | C8 (in nhcx-preauth) |
| Release the unpaid balance | nha:D12 | A6 (in nhcx-preauth) (release) | `v1/task/submit` | F10 (in nhcx-preauth) (Task) | 36 | `v1/task/on_submit` | F10 (in nhcx-preauth) | C8 (in nhcx-preauth) |
| Status of a leg | nha:A5 | A6 (in nhcx-preauth) (status) | `v1/task/submit` with a status Task [REF](PAYERS.md#markers); NHA lists `v1/status` | F10 (in nhcx-preauth) (Task) | the leg's correlation id, else 13 [REF](PAYERS.md#markers) | `v1/task/on_submit` or `v1/on_status` | F10 (in nhcx-preauth) | C8 (in nhcx-preauth) |
