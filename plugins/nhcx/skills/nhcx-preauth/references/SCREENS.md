...
| [S14](../screens/S14-patient-registration-form.md) | Patient Registration Form | `patients/new`, `patients/edit/:id` | Registers or edits a patient, including the ABHA number and address that link a claim to an admission. | [A4](../apis/A4-preauth-submit.md) | none |
| [S15](../screens/S15-patient-detail.md) | Patient Detail | `patients/view/:id` | The chart: overview, encounters, problems and allergies, vitals, laboratory and billing. | [A4](../apis/A4-preauth-submit.md) | none |

## Practitioner

| # | Screen | Route | What it does | APIs | Callbacks |
|---|---|---|---|---|---|
| [S16](../screens/S16-practitioner-master.md) | Practitioner Master | `practitioners/list` | Adds, edits and retires doctors, with the HPR id, registration and qualification the claim's care team sends; active doctors fill every picker. | [A4](../apis/A4-preauth-submit.md) | none |
