...
#### F1U. USED BY
- APIs: [A2. Coverage Eligibility Check](../apis/A2-coverage-eligibility-check.md), [A3. Insurance Plan Request](../apis/A3-insurance-plan-request.md), [A4. Pre-auth Submit](../apis/A4-preauth-submit.md), [A6. Task Submit (cancel, status, reprocess, release)](../apis/A6-task-submit.md), [A12. Transaction FHIR](../apis/A12-txn-fhir.md)
...
- FHIR: [F2. CoverageEligibilityRequest](F2-coverage-eligibility-request.md), [F4. Task (InsurancePlan discovery)](F4-task-insuranceplan.md), [F8. Claim](F8-claim.md), [F10. Task (claim actions)](F10-task-claim-actions.md)
