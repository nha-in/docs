...
This skill's scope is HIE-CM M1 to M3. Five more modules (`hiecm-p1.yaml` through `-p4.yaml`, `hiecm-scan-and-pay.yaml`) render the same way and are out of scope here, not out of existence.
