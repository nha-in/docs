...
- [Preauthorisation request](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-request)
- [Preauthorisation enhancement](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-enhancement)
- [Preauthorisation query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
- [Claim request](/docs/pr-48/docs/nhcx/v1/reference/fhir/claim-request)
- [Claim query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Communication](/docs/pr-48/docs/nhcx/v1/reference/fhir/communication)
...
- [Preauthorisation response](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-response)
- [Preauthorisation query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
- [Claim response](/docs/pr-48/docs/nhcx/v1/reference/fhir/claim-response)
- [Claim query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Cancel, reprocess and shortfall](/docs/pr-48/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall)
- [Status and search](/docs/pr-48/docs/nhcx/v1/reference/fhir/status-and-search)
...
- [Coverage eligibility request](/docs/pr-48/docs/nhcx/v1/reference/fhir/coverage-eligibility-request)
- [Coverage eligibility response](/docs/pr-48/docs/nhcx/v1/reference/fhir/coverage-eligibility-response)
- [Preauthorisation request](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-request)
- [Preauthorisation response](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-response)
- [Preauthorisation enhancement](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-enhancement)
- [Preauthorisation query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
...
- [Insurance plan response](/docs/pr-48/docs/nhcx/v1/reference/fhir/insurance-plan-response-overview)
- [Insurance plan response, package-based](/docs/pr-48/docs/nhcx/v1/reference/fhir/insurance-plan-response-package-based)
- [Insurance plan response, coverage-based](/docs/pr-48/docs/nhcx/v1/reference/fhir/insurance-plan-response-coverage-based)
...
- [Claim query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Cancel, reprocess and shortfall](/docs/pr-48/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall)
- [Payment notice and acknowledgement](/docs/pr-48/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement)
- [Communication](/docs/pr-48/docs/nhcx/v1/reference/fhir/communication)
- [Status and search](/docs/pr-48/docs/nhcx/v1/reference/fhir/status-and-search)
...
- [Insurance plan request](/docs/pr-48/docs/nhcx/v1/reference/fhir/insurance-plan-request)
- [Preauthorisation query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/preauthorisation-query-and-answer)
- [Claim query and answer](/docs/pr-48/docs/nhcx/v1/reference/fhir/claim-query-and-answer)
- [Cancel, reprocess and shortfall](/docs/pr-48/docs/nhcx/v1/reference/fhir/cancel-reprocess-and-shortfall)
- [Payment notice and acknowledgement](/docs/pr-48/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement)
