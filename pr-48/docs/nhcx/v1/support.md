...
- [Troubleshooting](/docs/pr-48/docs/nhcx/v1/troubleshooting): what to do when something breaks, by symptom.
- [Troubleshooting by layer and code](/docs/pr-48/docs/nhcx/v1/reference/troubleshooting): every layer of a call, and what each error code means there.
- [Error codes](/docs/pr-48/docs/nhcx/v1/reference/error-codes): every code with its message.
