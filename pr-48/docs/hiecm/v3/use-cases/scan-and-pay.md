...
Let a patient pay for their open orders from their [PHR](/docs/pr-48/docs/hiecm/v3/getting-started/glossary#phr) app after scanning the QR code at your counter. Your system is the [HIP](/docs/pr-48/docs/hiecm/v3/getting-started/glossary#hip) that holds the orders. The app is the [HIU](/docs/pr-48/docs/hiecm/v3/getting-started/glossary#hiu) that shows them, takes the selection and the payment, and reports back. The calls run through the [HIE-CM](/docs/pr-48/docs/hiecm/v3/getting-started/glossary#hie-cm) and land on the bridge you register for [M2](/docs/pr-48/docs/hiecm/v3/milestones/m2).
...
- Same counter QR code as [Scan and Register](/docs/pr-48/docs/hiecm/v3/use-cases/scan-and-register). The app sends the patient's payment details instead of a profile.
...
The request and response bodies, with every field, are on the [Scan and Pay API reference](/docs/pr-48/docs/hiecm/v3/api/scan-and-pay/endpoints/scan-and-pay-abdm-scan-pay-hip/01-scan-and-pay-post-v3-patient-share-open-order). No call on this page has been run against sandbox.
...
- The bridge these callbacks land on: [M2 Health Information Provider](/docs/pr-48/docs/hiecm/v3/milestones/m2).
- The app's side: [P2 Consents Management](/docs/pr-48/docs/hiecm/v3/milestones/p2).
