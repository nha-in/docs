...
The full operation list is in the [Scan and Register API reference](/docs/pr-48/reference/hiecm-scan-and-register).

New to this? Start with [Scan and Register](/docs/pr-48/docs/hiecm/v3/use-cases/scan-and-register).
