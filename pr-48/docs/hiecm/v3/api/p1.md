...
The full operation list is in the [P1 Registration and login API reference](/docs/pr-48/reference/hiecm-p1).

New to this? Start with [P1 Registration and login](/docs/pr-48/docs/hiecm/v3/milestones/p1).
