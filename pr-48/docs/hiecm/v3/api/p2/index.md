...
`https://nha-in.github.io/docs/pr-48/postman/hiecm-p2.postman_collection.json`
...
The full operation list is in the [P2 Consents Management API reference](/docs/pr-48/reference/hiecm-p2).

New to this? Start with [P2 Consents Management](/docs/pr-48/docs/hiecm/v3/milestones/p2).
