# NHCX Services - Request and Response

*Source: `hmisdocuments/NHCX Services - Request and Response.xlsx` — all sheets*
...
| Task Output Type Values |  |
| Code | Description |
| claimresponse | Claim Response resource for the given claim number created in payer system |
| paymentnotice | Payment Notice resource for the payment initiated by payer in payer system |
| Other | Any other resource as per input type |
...
| Approved | product or service requested is approved by the policy |
