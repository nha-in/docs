...
P1 is the patient side of [M1 Identity](/docs/pr-29/docs/hiecm/v3/milestones/m1). M1 is how a hospital system creates an [ABHA](/docs/pr-29/docs/hiecm/v3/getting-started/glossary#abha). P1 is how the patient's own [PHR](/docs/pr-29/docs/hiecm/v3/getting-started/glossary#phr) app does it, and how it maintains the account afterwards.
...
Registration and login. The profile the patient reads and edits is [P2](/docs/pr-29/docs/hiecm/v3/milestones/p2).
...
A person does not need an [ABHA number](/docs/pr-29/docs/hiecm/v3/getting-started/glossary#abha-number), and does not need Aadhaar, to get an ABHA address here. A mobile number and the OTP sent to it are enough. What that buys is a Self-Declared profile: an address the network can route to, with no [KYC](/docs/pr-29/docs/hiecm/v3/getting-started/glossary#kyc) behind it and no ABHA number until the person links one later.

| Path                                    | Validated by                                                         | Profile details             | Result                                                                          |
| --------------------------------------- | -------------------------------------------------------------------- | --------------------------- | ------------------------------------------------------------------------------- |
| Mobile number                           | Mobile [OTP](/docs/pr-29/docs/hiecm/v3/getting-started/glossary#otp) | The user types them         | Self-Declared, no [KYC](/docs/pr-29/docs/hiecm/v3/getting-started/glossary#kyc) |
...
- The calls and base URLs: [P1 API reference](/docs/pr-29/reference/hiecm-p1).
- The next milestone: [P2 Linking and records](/docs/pr-29/docs/hiecm/v3/milestones/p2).
