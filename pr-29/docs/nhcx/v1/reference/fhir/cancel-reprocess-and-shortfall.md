...
`suspend` is a listed code with no exchange behind it, so it has no row. A payment acknowledgement does not travel here: it goes on `/v1/paymentnotice/on_request`, as [Payment notice and acknowledgement](/docs/pr-29/docs/nhcx/v1/reference/fhir/payment-notice-and-acknowledgement) sets out.
...
|                    |                                                                                                                                  |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/task/submit` [`apis/13-other/v1-task-submit.bru`](/docs/pr-29/docs/nhcx/v1/api/task/endpoints/task-v1-task-submit)          |
| **Callback**       | `/v1/task/on_submit` [`apis/13-other/v1-task-on-submit.bru`](/docs/pr-29/docs/nhcx/v1/api/task/endpoints/task-v1-task-on-submit) |
...
|                    |                                                                                                                                  |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/task/on_submit` [`apis/13-other/v1-task-on-submit.bru`](/docs/pr-29/docs/nhcx/v1/api/task/endpoints/task-v1-task-on-submit) |
| **Callback**       | `/v1/task/submit` [`apis/13-other/v1-task-submit.bru`](/docs/pr-29/docs/nhcx/v1/api/task/endpoints/task-v1-task-submit)          |
