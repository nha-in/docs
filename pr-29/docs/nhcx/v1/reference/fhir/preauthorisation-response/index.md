...
|                    |                                                                                                                                                   |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/preauth/on_submit` [`apis/03-preauth/v1-preauth-on-submit.bru`](/docs/pr-29/docs/nhcx/v1/api/preauth/endpoints/preauth-v1-preauth-on-submit) |
| **Callback**       | `/v1/preauth/submit` [`apis/03-preauth/v1-preauth-submit.bru`](/docs/pr-29/docs/nhcx/v1/api/preauth/endpoints/preauth-v1-preauth-submit)          |
