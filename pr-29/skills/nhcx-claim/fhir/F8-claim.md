...
- FHIR: [F1. Bundle](F1-bundle.md), [F7. QuestionnaireResponse](F7-questionnaireresponse.md), [F9. ClaimResponse](F9-claimresponse.md), [F15. Patient](F15-patient.md), [F16. Practitioner and PractitionerRole](F16-practitioner.md), [F17. Organization](F17-organization.md), [F18. Coverage](F18-coverage.md), [F19. Other bundle resources](F19-other-resources.md)
