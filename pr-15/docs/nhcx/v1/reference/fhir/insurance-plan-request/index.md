...
|                    |                                                                                                                                                                                             |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **API**            | `/v1/insuranceplan/request` [`apis/09-insurance-plan/v1-insuranceplan-request.bru`](/docs/pr-15/docs/nhcx/v1/api/insurance-plan/endpoints/insurance-plan-v1-insuranceplan-request)          |
| **Callback**       | `/v1/insuranceplan/on_request` [`apis/09-insurance-plan/v1-insuranceplan-on-request.bru`](/docs/pr-15/docs/nhcx/v1/api/insurance-plan/endpoints/insurance-plan-v1-insuranceplan-on-request) |
| **Carries JWE**    | yes                                                                                                                                                                                         |
| **Focal resource** | `Task`                                                                                                                                                                                      |
