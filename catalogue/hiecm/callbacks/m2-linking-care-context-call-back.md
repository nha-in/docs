...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 9.3.4. The path, the method, the request body
...
```bash
curl -X POST '<YOUR_BRIDGE_URL>{callback\_url}/api/v3/link/on\_carecontext' \
  -H 'Authorization: Bearer <ACCESS_TOKEN>' \
  -H 'REQUEST-ID: <FRESH_UUID>' \
  -H 'TIMESTAMP: <ISO_8601_TIMESTAMP>' \
  -H 'Content-Type: application/json' \
  -d '{ "error": { "code": "ABDM-1056", "message": "This care context has been already linked" }, "response": { "requestId": "5ad6e060-ea35-4765-8c8c-cd7db8cb1a6f" }}'
```
...
The error scenarios NHA records against this call: ABDM-1056. The PHR codes
