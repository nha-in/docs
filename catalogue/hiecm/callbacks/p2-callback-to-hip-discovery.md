...
milestone: P2
version: abdm-v3
title: HIE-CM callback to HIP - Discovery
summary: >
...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 10.3.2. The path, the method
...
```bash
curl -X POST '<YOUR_BRIDGE_URL>{callback\_url}/api/v3/hip/patient/care-context/discover' \
...
section 10.3.2. That section gives no request body, so the body above is a placeholder rather than a transcription.
