...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 7.3.2. The path, the method
...
```bash
curl -X POST '<YOUR_BRIDGE_URL>{callback\_url/api/v3/hiu/health-information/on-request' \
...
section 7.3.2. That section gives no request body, so the body above is a placeholder rather than a transcription.
...
The error scenarios NHA records against this call: ABDM-1092. The PHR codes
