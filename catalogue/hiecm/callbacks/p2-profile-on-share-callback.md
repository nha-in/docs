...
milestone: P2
version: abdm-v3
title: Profile on share – Callback
summary: >
...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 5.3.4. The path, the method
...
```bash
curl -X POST '<YOUR_BRIDGE_URL>{callback\_url}/api/v3/hiu/patient/on-share' \
...
section 5.3.4. That section gives no request body, so the body above is a placeholder rather than a transcription.
