...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 8.3.7. The path, the method, the request body
...
```bash
curl -X POST 'https://dev.abdm.gov.in/api/hiecm/subscriptionrequests/v3/{{subscription\_id}}/deny' \
