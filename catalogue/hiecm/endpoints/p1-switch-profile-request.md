...
summary: >
  This API will be used to switch between different user profiles (eKYC and non eKYC). If the user has multiple ABHA addresses, then if the user logs in via ABHA number/mobile number then user can switc
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    fetched: 2026-09-04
    hash: sha256:99320fbc4b9703fce4afed12d5eb0863431aaea25e814bc3fb9ab974d16acd75
    note: >
      NHA's PHR V3 document, section 3.37. The path, the method
...
```bash
curl -X GET 'https://abhasbx.abdm.gov.in/abha/api/v3/phr/app/login/profile/switch-profile' \
...
section 3.37. That section gives no request body, so the body above is a placeholder rather than a transcription.
