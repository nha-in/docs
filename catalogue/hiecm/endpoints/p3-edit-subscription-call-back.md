---
id: hiecm.endpoint.p3-edit-subscription-call-back
type: endpoint
gateway: hiecm
milestone: P3
version: abdm-v3
...
section 8.3.10. That section gives no request body, so the body above is a placeholder rather than a transcription.
