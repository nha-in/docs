...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 8.3.14. The path, the method
...
```bash
curl -X GET 'https://dev.abdm.gov.in/api/hiecm/subscription-requests/v3/request/{subscriptionId}' \
...
section 8.3.14. That section gives no request body, so the body above is a placeholder rather than a transcription.
