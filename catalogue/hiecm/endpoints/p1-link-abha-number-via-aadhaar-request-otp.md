...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 3.34. The path, the method, the request body
...
curl -X POST 'https://abhasbx.abdm.gov.in/abha/api/v3/phr/app/login/profile/request/otp' \
  ...
  -d '{ "scope": [ "abha-login", "aadhaar-verify" ], "loginHint": "abha-number", "loginId": "*{{encrypted abha-number}}*", "otpSystem": "aadhaar" }'
```
