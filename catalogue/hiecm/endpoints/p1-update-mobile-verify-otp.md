...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 3.27. The path, the method, the request body
...
curl -X POST 'https://abhasbx.abdm.gov.in/abha/api/v3/phr/app/login/profile/verify' \
  ...
  -d '{ "scope": [ "abha-address-profile", "mobile-verify" ], "authData": { "authMethods": [ "otp" ], "otp": { "txnId": "*{{ transactionId}}*", "otpValue":"*{{encrypted OTP}}*" } } }'
```
...
The error scenarios NHA records against this call: ABDM-1006, ABDM-1016, ABDM-9999. The PHR codes
