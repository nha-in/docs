...
milestone: P3
version: abdm-v3
title: Get consent Request details by consent request Id
summary: >
  Reads one consent request from its request id.
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    fetched: 2026-09-04
    hash: sha256:99320fbc4b9703fce4afed12d5eb0863431aaea25e814bc3fb9ab974d16acd75
    note: >
      NHA's PHR V3 document, section 6.17. The path, the method
...
# Get consent Request details by consent request Id

## In plain words

This API will be invoked by HIU to get the consent request by request id.
...
```bash
curl -X GET 'https://dev.abdm.gov.in/api/hiecm/consent/v3/request/{{consentRequestId}}' \
...
section 6.17. That section gives no request body, so the body above is a placeholder rather than a transcription.
