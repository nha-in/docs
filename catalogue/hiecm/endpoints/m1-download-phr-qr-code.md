...
summary: >
  Download the PHR QR code image..
sources:
...
```bash
curl -X GET 'https://abhasbx.abdm.gov.in/abha/api/v3/phr/web/login/profile/abha/qr-code' \
...
NHA calls this operation `downloadPhrQrCode`.
