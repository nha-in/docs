...
milestone: P3
version: abdm-v3
title: Subscription HIU – on notify
summary: >
...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 8.3.12. The path, the method
...
```bash
curl -X POST 'https://dev.abdm.gov.in/api/hiecm/subscription-requests/v3/hiu/care-context/on-notify' \
...
section 8.3.12. That section gives no request body, so the body above is a placeholder rather than a transcription.
