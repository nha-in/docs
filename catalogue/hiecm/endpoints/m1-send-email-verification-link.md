...
summary: >
  Send a one-click email verification link.
sources:
...
```bash
curl -X POST 'https://abhasbx.abdm.gov.in/abha/api/v3/profile/account/request/emailVerificationLink' \
...
NHA calls this operation `sendEmailVerificationLink`.
