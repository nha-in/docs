...
milestone: P1
version: abdm-v3
title: Process Link Request via AADHAAR Number
summary: >
...
sources:
  - file: catalogue/openapi/.raw/nha-2026-09-04/ABHA-PHR-V3-Documents.docx
    ...
    note: >
      NHA's PHR V3 document, section 3.36. The path, the method
...
# Process Link Request via AADHAAR Number
...
curl -X POST 'https://abhasbx.abdm.gov.in/abha/api/v3/phr/app/login/profile/link' \
  ...
  -d '{ "action": "LINK", "transactionId":"*{{ transactionId}}*" }'
```

The body above is transcribed from NHA's PHR V3 document, section 3.33, which publishes it for this call. It has not been sent to the
sandbox from this repository.

The path, the method and the body come from NHA's PHR V3 document,
section 3.36. That section gives no request body, so the body above is a placeholder rather than a transcription.
