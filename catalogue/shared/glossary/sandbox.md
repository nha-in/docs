---
id: shared.glossary.sandbox
type: glossary
gateway: shared
milestone: n/a
version: abdm-v3
title: Sandbox, the test environment
summary: >
...
You have understood this when you can name the base URL your calls are going to and say which environment it is.

## When it goes wrong

Assuming sandbox behaviour is production behaviour. Where this portal
has confirmed something against sandbox only, it says so.
