...
2. **Extract.** Regex out error codes (`ABDM-`, `GATEWAY-` and `MIS-` prefixes), endpoint paths, header names and HTTP status codes. These seed retrieval and skip a model round trip in the common case.
