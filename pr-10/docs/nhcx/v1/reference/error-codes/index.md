...
## Pre-authorisation, Reference Payer
...
## Insurance plan, Reference Payer
...
| Code | Message | What to do |
| --- | --- | --- |
| `ERR-PYR-CLM-007` | No prior preauthorization or claim record found for case number | On none of the seven sheets. The SHA HP sandbox sent it for a claim raised under a number of its own rather than the preauthorisation's. |

330 codes are recorded. A code you meet that is not here is one the specifications do not carry yet.
