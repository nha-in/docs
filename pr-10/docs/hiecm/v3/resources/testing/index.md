...
Every [HIE-CM](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#hie-cm) module has a set of cases your integration is tested against. They are listed here, one page per module, and each case keeps the id it carries at certification.

## Where you run them

You run these cases against the [sandbox](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#sandbox), on sandbox credentials. [Get your sandbox credentials](/docs/pr-10/docs/hiecm/v3/getting-started/sandbox) covers registration, the client id and secret, the callback URL and the base URLs.

Three things about the sandbox decide how a case behaves:

- **It runs on its own hosts, under its own credentials.** A production client id against a sandbox host fails, and so does the reverse. [Go live](/docs/pr-10/docs/hiecm/v3/getting-started/going-live) lists both sets.
...
| ---------------------------------------------------- | ---------------------------------------------------------------------- | ------------------- | ------------- |
| [M1](/docs/pr-10/docs/hiecm/v3/resources/testing/m1) | ABHA creation, verification, profile and share                         | 66                  | 56            |
| [M2](/docs/pr-10/docs/hiecm/v3/resources/testing/m2) | Care context linking, and sharing the records you hold                 | 36                  | 10            |
| [M3](/docs/pr-10/docs/hiecm/v3/resources/testing/m3) | Consent requests, and fetching records you did not create              | 16                  | 16            |
| [M4](/docs/pr-10/docs/hiecm/v3/resources/testing/m4) | Facility registration in the HFR, professional registration in the HPR | 184                 | None          |
...
A case that expects a callback needs that URL reachable from the public internet and listening, whether or not you are ready for the answer. In development that usually means a tunnel, and a tunnel gives you a new URL every restart. Register the new one each time. [Get your sandbox credentials](/docs/pr-10/docs/hiecm/v3/getting-started/sandbox) covers what the URL has to do.

## Next

- Start with [M1](/docs/pr-10/docs/hiecm/v3/resources/testing/m1).
- The calls each case makes: [API references](/docs/pr-10/docs/hiecm/v3/api).
- What happens once they pass: [Go live](/docs/pr-10/docs/hiecm/v3/getting-started/going-live).
