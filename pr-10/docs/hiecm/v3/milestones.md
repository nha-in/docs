...
[M1Create and verify the patient's ABHA, the identity every record hangs on.](/docs/pr-10/docs/hiecm/v3/milestones/m1)[M2Attach the records you hold to that identity: care contexts, linking, and sharing as a HIP.](/docs/pr-10/docs/hiecm/v3/milestones/m2)[M3Retrieve records held elsewhere, with the patient's consent, as an HIU.](/docs/pr-10/docs/hiecm/v3/milestones/m3)[M4Enrol your facility and your professionals in the registries, so you can go live.](/docs/pr-10/docs/hiecm/v3/milestones/m4)
...
1. Milestone 1 · CreateRegister Meera's ABHA
   ...
   [Build M1 Create](/docs/pr-10/docs/hiecm/v3/milestones/m1)
...
2. Milestone 2 · AttachAttach today's visit to her ABHA
   ...
   [Build M2 Attach](/docs/pr-10/docs/hiecm/v3/milestones/m2)
...
3. Milestone 3 · RetrieveRetrieve the scan from another hospital
   ...
   [Build M3 Retrieve](/docs/pr-10/docs/hiecm/v3/milestones/m3)
...
4. Milestone 4 · EnrolEnrol the clinic and its doctors
   ...
   [Build M4 Enrol](/docs/pr-10/docs/hiecm/v3/milestones/m4)

## The same story from Meera's own app

If you are building the patient's app rather than the clinic's system, you are building a [PHR](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#phr) application. The work splits into three, and each part mirrors a milestone on the provider side.
...
1. PHR 1 · Identity and profileMeera signs up and holds her own profile
   ...
   [Build P1](/docs/pr-10/docs/hiecm/v3/milestones/p1)
...
2. PHR 2 · Linking and recordsShe finds records she never linked
   ...
   [Build P2](/docs/pr-10/docs/hiecm/v3/milestones/p2)
...
3. PHR 3 · Consent and notificationsShe decides who sees what
   ...
   [Build P3](/docs/pr-10/docs/hiecm/v3/milestones/p3)
...
| An insurer, a referral service or an analytics service | Required                                                        | Not needed                                                      | The bulk of your build                                          | [Confirm at onboarding](/docs/pr-10/docs/hiecm/v3/concepts/participants/insurer#confirm-at-onboarding) |
| A citizen                                              | [P1](/docs/pr-10/docs/hiecm/v3/milestones/p1), the patient side | [P2](/docs/pr-10/docs/hiecm/v3/milestones/p2), the patient side | [P3](/docs/pr-10/docs/hiecm/v3/milestones/p3), the patient side | Not needed                                                                                             |

## What each milestone gets you

| Milestone                                              | What you get                                | Who needs it                                                   |
| ------------------------------------------------------ | ------------------------------------------- | -------------------------------------------------------------- |
| [M1 Create](/docs/pr-10/docs/hiecm/v3/milestones/m1)   | Identity and the session token              | Everyone                                                       |
| [M2 Attach](/docs/pr-10/docs/hiecm/v3/milestones/m2)   | Linking and sharing records                 | A facility publishing records, and a citizen pushing their own |
| [M3 Retrieve](/docs/pr-10/docs/hiecm/v3/milestones/m3) | Consent and record fetching                 | Anyone reading records they did not create, and every PHR app  |
| [M4 Enrol](/docs/pr-10/docs/hiecm/v3/milestones/m4)    | A facility ID and professional registration | Anyone going live as a facility                                |

These pages give the steps, the order to build them in and the failure modes. Every request URL, header and body sits on the [API reference](/docs/pr-10/docs/hiecm/v3/api) pages, one page per call.

## Next

Start with [M1 Create](/docs/pr-10/docs/hiecm/v3/milestones/m1), or read [Go live](/docs/pr-10/docs/hiecm/v3/getting-started/going-live) for what happens after the fourth certificate.
