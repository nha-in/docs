...
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [ABDM](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#abdm), NDHM           | The programme. NDHM is the former name and both appear in the source.                                                                           |
| [PHR](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#phr)                   | Personal health record application.                                                                                                             |
| [HIU](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#hiu)                   | Health information user.                                                                                                                        |
| [UHI](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#uhi)                   | Unified Health Interface.                                                                                                                       |
| [NHCX](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#nhcx)                 | National Health Claims Exchange.                                                                                                                |
| [HMIS](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#hmis)                 | Hospital management information system.                                                                                                         |
| [OTP](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#otp)                   | One time password.                                                                                                                              |
| SPOC                                                                            | Single point of contact, the named person on an application.                                                                                    |
| [HTC](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#health-tech-committee) | Health Tech Committee, the body that reviews your integration at the end of the exit process.                                                   |
| [WASA](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#wasa)                 | The security audit that produces your Safe to Host certificate. See [Security audit](/docs/pr-10/docs/hiecm/v3/getting-started/security-audit). |
...
This dictionary describes the sandbox portal, not the [ABDM](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#abdm) APIs. It carries no request shape, no response shape and no endpoint. Registry identifiers such as [ABHA](/docs/pr-10/docs/hiecm/v3/getting-started/glossary#abha) numbers do not appear in it at all.

For the APIs, start at [choose your gateway](/docs/pr-10/docs/hiecm/v3). For the sandbox itself and how to sign up, read [get started](/docs/pr-10/docs/hiecm/v3/getting-started/sandbox).
