...
- [ABHA Creation and Verification (M1)](https://nha-in.github.io/docs/pr-33/skills/abdm-m1/SKILL.md)
- [Health Information Provider Services (M2)](https://nha-in.github.io/docs/pr-33/skills/abdm-m2/SKILL.md)
- [Health Information User Services (M3)](https://nha-in.github.io/docs/pr-33/skills/abdm-m3/SKILL.md)
- [National Healthcare Providers Registry (M4)](https://nha-in.github.io/docs/pr-33/skills/abdm-m4/SKILL.md)
- [PHR registration and login (P1)](https://nha-in.github.io/docs/pr-33/skills/abdm-p1/SKILL.md)
- [Consents Management (P2)](https://nha-in.github.io/docs/pr-33/skills/abdm-p2/SKILL.md)
- [PHR subscriptions (P3)](https://nha-in.github.io/docs/pr-33/skills/abdm-p3/SKILL.md)
- [Health lockers (P4)](https://nha-in.github.io/docs/pr-33/skills/abdm-p4/SKILL.md)
- [FHIR bundles](https://nha-in.github.io/docs/pr-33/skills/abdm-fhir/SKILL.md)
...
| Identifiers are encrypted, and the plaintext has a shape                                            | An agent encrypts what looks like the value. An ABHA number keeps its dashes, and the bare digits are refused. See [encryption](/docs/pr-33/docs/hiecm/v3/concepts/encryption)                                                  |
| Callbacks are how the answer arrives in M2 and M3                                                   | Left alone, an agent writes a synchronous call and a response handler for a flow where the 202 means accepted and nothing else. See [the gateway](/docs/pr-33/docs/hiecm/v3/concepts/gateway)                                   |
...
Point it at [Build it well](/docs/pr-33/docs/hiecm/v3/getting-started/build-it-well) for the handling rules themselves: what to validate, what each error means, what is safe to retry, and what the screen should say.
...
[View llms.txt](/docs/pr-33/llms.txt)[View llms-full.txt](/docs/pr-33/llms-full.txt)[This page as Markdown](/docs/pr-33/docs/hiecm/v3/getting-started/build-with-ai/index.md)
