---
name: hiecm-scan-and-pay-build
description: "Use when scaffolding an integration against ABDM SCAN-AND-PAY (open orders, patient selection and payment status between a facility and a PHR app): builds each journey as an observe-orient-decide-act loop against the sandbox."
---
