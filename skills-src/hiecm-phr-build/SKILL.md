---
name: hiecm-phr-build
description: "Use when scaffolding an integration against ABDM PHR (the patient side: ABHA address, login, discovery, linking, consent and lockers): builds each journey as an observe-orient-decide-act loop against the sandbox."
---
# HIE-CM phr build
