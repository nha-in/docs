...
description: "Use when scaffolding an integration against ABDM SUBSCRIPTION (subscribing an HIU to changes on an ABHA address): builds each journey as an observe-orient-decide-act loop against the sandbox."
---
