...
Seeing a symptom rather than a code? Start at [Troubleshooting](/docs/pr-11/docs/hiecm/v3/troubleshooting/).
...
The algorithm is published: read `encryptionAlgorithm` from the certificate response. The plaintext shape for every encrypted field is in [encryption](/docs/pr-11/docs/hiecm/v3/concepts/encryption).
...
Every code above is recorded in the specification that owns it. The aggregated list across modules is at [error codes](/docs/pr-11/docs/hiecm/v3/reference/error-codes).
